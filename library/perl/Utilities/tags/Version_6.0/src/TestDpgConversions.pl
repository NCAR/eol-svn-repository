...
sub stateCode {
  ...
  $self->assertValue(27, getStateCodeFromFile("MN","US"));
  $self->assertString("MN", getStateCodeFromFile(27,"US"));
  
  $self->assertValue(3, getStateCodeFromFile("Manitoba","CA"));
  $self->assertString("Manitoba", getStateCodeFromFile(3,"CA"));

  $self->assertValue(23, getStateCodeFromFile("Quintana Roo","MX"));
  $self->assertString("Quintana Roo", getStateCodeFromFile(23,"MX"));
}
