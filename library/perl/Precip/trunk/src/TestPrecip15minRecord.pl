...
sub main {
    my $tester = TestPrecip15minRecord->new();
    my $record = Precip15minRecord->new(*STDOUT);
...
sub testMetadata {
    ...
    $record = Precip15minRecord->new(*STDOUT,$station);
