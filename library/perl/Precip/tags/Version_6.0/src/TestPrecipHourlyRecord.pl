...
package TestPrecipHourlyRecord;
use strict;
...
sub main {
    my $tester = TestPrecipHourlyRecord->new();
    my $record = PrecipHourlyRecord->new(*STDOUT);
...
sub testMetadata {
    ...
    $record = PrecipHourlyRecord->new(*STDOUT,$station);
...
sub testToString {
    ...
    $self->assertString("2005/05/05 00:00:00 Network    Station          -99.99999  -999.99999   0    0.00 0 B    1.00 0 B    2.00 0 B    3.00 0 B    4.00 0 B    5.00 0 B    6.00 0 B    7.00 0 B    8.00 0 B    9.00 0 B   10.00 0 B   11.00 0 B   12.00 0 B   13.00 0 B   14.00 0 B   15.00 0 B   16.00 0 B   17.00 0 B   18.00 0 B   19.00 0 B   20.00 0 B   21.00 0 B   22.00 0 B   23.00 0 B\n",$record->toString(),"Test toString");
}
