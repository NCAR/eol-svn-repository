...
sub getStation {
    my $self = shift;
    if (scalar(@_) != 4) { die("Invalid parameters to getStation\n"); }
...
sub hasStation {
    my $self = shift;
    if (scalar(@_) != 4) { die("Invalid parameters to hasStation\n"); }
