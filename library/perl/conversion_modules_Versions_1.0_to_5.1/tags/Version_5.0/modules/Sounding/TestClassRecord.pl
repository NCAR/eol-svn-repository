...
package Sounding::TestClassRecord;
use strict;
use lib "..";
use TestModule;
...
sub main {
    my $tester = Sounding::TestClassRecord->new();
...
sub testAltitude {
    my $self = shift;
    my $record = Sounding::ClassRecord->new($WARN,$warning);
...
sub testAscensionRate {
    my $self = shift;
    my $prev = Sounding::ClassRecord->new($WARN,$warning);
    my $record = Sounding::ClassRecord->new($WARN,$warning,$prev);
