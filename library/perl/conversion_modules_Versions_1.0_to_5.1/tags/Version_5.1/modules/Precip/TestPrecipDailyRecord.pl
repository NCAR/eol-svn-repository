...
package Precip::TestPrecipDailyRecord;
use strict;
use lib "..";
use DpgConstants qw(:DEFAULT);
use DpgDate qw(:DEFAULT);
use Precip::PrecipDailyRecord;
use Station::Station;
...
sub main {
    my $tester = Precip::TestPrecipDailyRecord->new();
    my $record = Precip::PrecipDailyRecord->new(*STDOUT);
...
sub testMetadata {
    ...
    $record = Precip::PrecipDailyRecord->new(*STDOUT,$station);
...
sub testToString {
    ...
    $self->assertString("2005/05 Network    Station         -999.99999  -999.99999   0    1.00 1 B 01    2.00 2 B 02    3.00 3 B 03    4.00 0 B 04    5.00 1 B 05    6.00 2 B 06    7.00 3 B 07    8.00 0 B 08    9.00 1 B 09   10.00 2 B 10   11.00 3 B 11   12.00 0 B 12   13.00 1 B 13   14.00 2 B 14   15.00 3 B 15   16.00 0 B 16   17.00 1 B 17   18.00 2 B 18   19.00 3 B 19   20.00 0 B 20   21.00 1 B 21   22.00 2 B 22   23.00 3 B 23   24.00 0 B 00   25.00 1 B 01   26.00 2 B 02   27.00 3 B 03   28.00 0 B 04   29.00 1 B 05   30.00 2 B 06   31.00 3 B 07\n",$record->toString(),"Test toString");
}
