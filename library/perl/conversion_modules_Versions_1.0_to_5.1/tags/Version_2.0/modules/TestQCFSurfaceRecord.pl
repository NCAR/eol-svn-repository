...
package TestQCFSurfaceRecord;
use strict;
use lib ".";
use QCFSurfaceRecord;
use TestModule;
our @ISA = ("TestModule");
&main();
...
sub main {
    my $tester = TestQCFSurfaceRecord->new();
...
sub testLargeValues {
    my $self = shift;
    my $record = QCFSurfaceRecord->new($WARNING);
    $record->setVerbose(0);
...
sub testConstants {
    ...
    $self->assertString("-999.99", $record->getMissing(), "Missing Value");
    $self->assertString("B", $record->getBadFlag(), "Bad Flag");
    $self->assertString("D", $record->getDubiousFlag(), "Dubious Flag");
    $self->assertString("E", $record->getEstimateFlag(), "Estimate Flag");
    $self->assertString("X", $record->getGlitchFlag(), "Glitch Flag");
    $self->assertString("M", $record->getMissingFlag(), "Missing Flag");
    $self->assertString("C", $record->getNegativePrecipFlag(), 
			"Negative Precip Flag");
    $self->assertString("N", $record->getNoReadingFlag(), "No Reading Flag");
    $self->assertString("T", $record->getTracePrecipFlag(), 
			"Trace Precip Flag");
    $self->assertString("C", $record->getValueDoesNotFitFlag(), 
			"Value Does Not Fit Flag");
}
...
sub testCalcSLPressure {
    ...
    $self->assertFormatString($record->getMissing(),
			      $record->getCalcSeaLevelPressure(),
			      "Default Calc Sea Level Pressure");
    $self->assertString($record->getIncalcuableFlag(),
    ...
    $self->assertString($record->getUncheckedFlag(),
			$record->getCalcSeaLevelPressureFlag(),
...
sub testCeilingHeight {
    ...
    $self->assertString($record->getMissingFlag(),
    ...
    $record->setCeilingHeightFlag($record->getEstimateFlag(), $height);
    $self->assertString($record->getEstimateFlag(),
			$record->getCeilingHeightFlag($height),
...
sub testCloudAmount {
    ...
    $record->setCloudAmountFlag($record->getEstimateFlag(), $height);
    $self->assertString($record->getEstimateFlag(),
			$record->getCloudAmountFlag($height),
...
sub testDewPoint {
    ...
    $self->assertFormatString($record->getMissing(), $record->getDewPoint(),
			      "Default Dew Point");
    $self->assertString($record->getIncalcuableFlag(), 
			$record->getDewPointFlag(), "Default Dew Point Flag");
    $record->setTemperature(23, "C");
    $record->setRelativeHumidity(50, 1);
    ...
    $record->setDewPointFlag($record->getEstimateFlag());
    $self->assertString($record->getEstimateFlag(), $record->getDewPointFlag(),
			"Set Dew Point Flag");
}
...
sub testElevation {
    ...
    $self->assertString($record->getMissing(), $record->getElevation(),
			"Default Elevation");
...
sub testGustSpeed {
    ...
    $self->assertFormatString($record->getMissing(), $record->getGustSpeed(),
			      "Default Gust Speed");
    $self->assertString(" ", $record->getGustMarker(), "Default Gust Marker");
    $self->assertString($record->getMissingFlag(), $record->getGustSpeedFlag(),
    ...
    $record->setGustSpeedFlag($record->getEstimateFlag());
    $self->assertString($record->getEstimateFlag(), 
...
sub testPrecip {
    ...
    $self->assertFormatString($record->getMissing(), $record->getPrecip(),
			      "Default Precip");
    $self->assertString($record->getMissingFlag(), $record->getPrecipFlag(),
			"Default Precip Flag");
    $record->setPrecip(11, "mm");
    $self->assertFormatString(11, $record->getPrecip(), "Precip");
    $self->assertString($record->getUncheckedFlag(), $record->getPrecipFlag(),
			"Calc Precip Flag");
    $record->setPrecipFlag($record->getEstimateFlag());
    $self->assertString($record->getEstimateFlag(), $record->getPrecipFlag(),
			"Set Precip Flag");
}
...
sub testPresentWeather {
    ...
    $record->setPresentWeatherFlag($record->getEstimateFlag());
    $self->assertString($record->getEstimateFlag(),
			$record->getPresentWeatherFlag(),
...
sub testPressure {
    ...
    $self->assertFormatString($record->getMissing(), $record->getPressure(),
			      "Default Station Pressure");
    $self->assertString($record->getMissingFlag(), $record->getPressureFlag(),
    ...
    $self->assertString($record->getUncheckedFlag(),$record->getPressureFlag(),
			"Calc Station Pressure Flag");
    $record->setPressureFlag($record->getEstimateFlag());
    $self->assertString($record->getEstimateFlag(), $record->getPressureFlag(),
...
sub testSLPressure {
    ...
    $record->setSeaLevelPressureFlag($record->getEstimateFlag());
    $self->assertString($record->getEstimateFlag(),
			$record->getSeaLevelPressureFlag(),
...
sub testTemperature {
    ...
    $self->assertFormatString($record->getMissing(), $record->getTemperature(),
			      "Default Temperature");
    $self->assertString($record->getMissingFlag(), 
    ...
    $record->setTemperatureFlag($record->getEstimateFlag());
    $self->assertString($record->getEstimateFlag(), 
...
sub testVisibility {
    ...
    $self->assertFormatString($record->getMissing(), $record->getVisibility(),
			      "Default Visibility");
    $self->assertString($record->getMissingFlag(),$record->getVisibilityFlag(),
    ...
    $record->setVisibilityFlag($record->getEstimateFlag());
    $self->assertString($record->getEstimateFlag(),
...
sub testWindDirection {
    ...
    $record->setWindDirectionFlag($record->getEstimateFlag(),
				  $record->getWindDirectionFlag(),
...
sub testWindSpeed {
    ...
    $self->assertFormatString($record->getMissing(), $record->getWindSpeed(),
			      "Default Wind Speed");
    $self->assertString($record->getMissingFlag(),$record->getWindSpeedFlag(),
    ...
    $record->setWindSpeedFlag($record->getEstimateFlag());
    $self->assertString($record->getEstimateFlag(),$record->getWindSpeedFlag(),
			"Set Wind Speed Flag");
}
