...
sub testLatitude {
    ...
    $self->assertValue(-999.99999,$station->getLatitude(),"latitude: default");
...
sub testToString {
    ...
    $self->assertString("Station           -1 -999.99999  -999.99999   0     1 Description                                    (N) 99999999 00000000 US 99 ???   0.00 n   -1 xxxxxx            -9999.9 f\n",$station->toString(),"toString: default");
