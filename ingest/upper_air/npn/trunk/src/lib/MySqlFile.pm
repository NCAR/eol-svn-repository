...
##-----------------------------------------------------------------------------
# @signature String insert(MySqlTestDatabase db)
...
sub insert {
    ...
    #open dataset
    my $dataset = MySqlTestDataset->new($self->getDatasetId());
...
##-----------------------------------------------------------------------------
# @signature bool load(long/string dataset_id, string directory, string filename, MySqlTestDatabase database)
# <p>Increments a supplied date by one day. Returns array (Year,Month,Day,hour,minute,second) </p>
##-----------------------------------------------------------------------------
