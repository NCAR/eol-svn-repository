...
# need to get file size for database insert from the CS location
...
# -r--r-----+ 1 eoldata eoldata 28620800 Oct  6 10:00 sa20211004.gem
# File Size is @cs_output[4] value
#
#
#  @author Linda Echo-Hawk
...
my $mss = "/FS/EOL/operational/satellite/hdw";
...
sub sendMailAndDie {
    my ($body) = @_;
    MAIL::send_mail("LDM MADIS HDW Satellite Winds MSS/CODIAC Script Error\n",$0."\n\n".$body, @monitors);
    exit(1);
}
