...
public class NcepInserter {
    ...
    private static final String URL = "jdbc:mysql://ingest.eol.ucar.edu/zedi";
    private static final String USER = "zediupdate";
    private static final String PASS = "change-456";
    ...
    private PreparedStatement datasetStmt, fileStmt;
     ...
     **/
    public NcepInserter(int month, int year) throws ClassNotFoundException, SQLException {
        this.month = month;
        this.year = year;
	...
	// in the database.
        fileStmt = connection.prepareStatement("INSERT INTO file(dataset_id,host,directory,filename," +
                                               ...
                                               "VALUES(?,'localhost',?,?,?,?,?,?,'data',?)");
        datasetStmt = connection.prepareStatement("UPDATE dataset SET " + 
						  "begin_date=(SELECT MIN(begin_date) FROM file WHERE " +
						  "dataset_id=? AND purpose='data' AND filename!='nwsli.uniq.new'),"+
						  "end_date=(SELECT MAX(end_date) FROM file WHERE dataset_id=? " +
						  "AND purpose='data' and filename!='nwsli.uniq.new') " +
						  "WHERE dataset_id=?");
    }
    ...
    /**
     * Insert the *.Z files found in the specified directory in the database
     ...
     * the file name.  It should be something like Calendar.MINUTE.
	...
	// Loop through all of the files found in the directory.
		...
		// Set the remaining parts of the statement.
                ...
                fileStmt.setInt(6, COMPRESS_FILE_FORMAT);
	...
	// Update the dataset begin and end dates.
        ...
        datasetStmt.setString(2, datasetId);
    ...
    public void insertGag4Files(String archive) throws SQLException {
        ...
        insertCompressFiles(directory, datasetId, Calendar.MINUTE);
    }
	...
	// Insert the files for each dataset.  Order is important here.
        try {
            ...
            inserter.insertGag4Files(archive);
