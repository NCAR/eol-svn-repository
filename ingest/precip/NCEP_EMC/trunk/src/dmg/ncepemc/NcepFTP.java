 ...
 * @author Joel Clawson
 *
 * Commented out download*Files try/catch blocks for files we now retrieve 
 * from the NOAA NOMADS server by cron script.
 *
...
public class NcepFTP {
	...
	try {
        ...
        // because we are now downloading these from NOMADS 
		// try {
