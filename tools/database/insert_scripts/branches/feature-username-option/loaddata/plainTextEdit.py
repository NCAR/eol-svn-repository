...
class plainTextEditField(QtGui.QWidget):
    ...
    def load(self, loadData):
        ...
        if loadPlainData:
            self.plainTextEdit.appendPlainText(str(self.loadData['dataset'][self.row][self.name]))
        else:
    ...
    def save(self, saveData):
        ...
        if savePlainData:
            self.saveData['dataset'][self.row][self.name] = str(self.plainTextEdit.toPlainText())
        else:
