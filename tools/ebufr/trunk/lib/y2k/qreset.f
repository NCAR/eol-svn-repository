...
c
c     002 Oct 18, 2000 Janine Goldstein
c         Modified to be y2k compliant by including space for century in
c     nominal date and actual date, and dividing date array,
c     which was character*2 nomdate(3), into individual year, month,
c     and day variables.
