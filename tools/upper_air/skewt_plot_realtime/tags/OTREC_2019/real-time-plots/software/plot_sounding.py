...
PLOTDIR = '/net/work/Projects/OTREC/real-time-plots/data_processing/output_plots/'
FILENAME = sys.argv[1]
...
title = time.strftime('%Y/%m/%d  %H:%M') + ' UTC   ' + location
...
skew.plot_wind_barbs(ax2, prof.pres[::50], prof.u[::50], prof.v[::50])
