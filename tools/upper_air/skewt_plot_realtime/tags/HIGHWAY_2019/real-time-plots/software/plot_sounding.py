...
PLOTDIR = '/net/work/Projects/HIGHWAY/real-time-plots/data_processing/output_plots/'
FILENAME = sys.argv[1]
...
plotfile_name = 'upperair.SkewT.' + time.strftime('%Y%m%d%H%M.') + location.partition(',')[0] + '_KE'
