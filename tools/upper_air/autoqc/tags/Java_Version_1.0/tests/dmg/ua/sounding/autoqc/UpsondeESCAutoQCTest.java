...
public class UpsondeESCAutoQCTest extends ESCAutoQCTest {

	@BeforeClass public static void setUpBeforeClass() throws Exception {
		autoQC = new UpsondeESCAutoQC("upsonde_test_limits");
		coldQC = new UpsondeESCAutoQC("upsonde_cold_test_limits");
	}

	@Override
	public void decreasePressureDecreaseOverThreshold() throws
	...
	@Override
	public void decreasePressureIncreaseOverThreshold() throws
    ConversionException, InvalidValueWarning, IOException {
		// Build the records used for the check.
    	ESCSoundingRecord start = buildPTURecord(100.1, 20.0, 15.0);
	...
	@Override
	public void canCheckPressureRates() throws 
		ConversionException, InvalidValueWarning, IOException {
		assertTrue("Check Press Rates", autoQC.canCheckPressureRates(null));
	}

	@Override
	public void checkTimeNoCurrentNoNextNoPrevTime() throws 
	ConversionException, InvalidValueWarning, IOException {
	...
	@Override
	public void checkTimeNoCurrentNoNextValidPrevTime() throws 
	ConversionException, InvalidValueWarning, IOException {
		ESCSoundingRecord start = new ESCSoundingRecord();
		ESCSoundingRecord end = new ESCSoundingRecord();
	...
	@Override
	public void checkTimeNoCurrentValidNextNoPrevTime() throws
	...
	@Override
	public void checkTimeNoCurrentValidNextValidPrevTimeEqual() throws
	...
	@Override
	public void checkTimeNoCurrentValidNextValidPrevTimeGreat() throws
	ConversionException, InvalidValueWarning, IOException, CalculationWarning {
		ESCSoundingRecord start = new ESCSoundingRecord();
		ESCSoundingRecord end = new ESCSoundingRecord();
		end.setTime(5.0);
		...
		assertTrue("Time Check - Null/Value/Value Great: log ready - pre", 
				reader.ready());
		assertFalse("Time Check - Null/Value/Value Great: log output", 
				"".equals(reader.readLine()));
		assertFalse("Time Check - Null/Value/Value Great: log ready - post", 
				reader.ready());
	...
	@Override
	public void checkTimeNoCurrentValidNextValidPrevTimeLess() throws 
	ConversionException, InvalidValueWarning, IOException, CalculationWarning {
		ESCSoundingRecord start = new ESCSoundingRecord();
		ESCSoundingRecord end = new ESCSoundingRecord();
		end.setTime(5.0);
		...
		assertFalse("Time Check - Null/Value/Value Less: log ready", 
				reader.ready());
	...
	@Override
	public void checkTimeValidCurrentNoNextNoPrevTime() throws 
	ConversionException, InvalidValueWarning, IOException, CalculationWarning {
		ESCSoundingRecord start = new ESCSoundingRecord();
		ESCSoundingRecord end = new ESCSoundingRecord();
		start.setTime(1.0);
	...
	@Override
	public void checkTimeValidCurrentNoNextValidPrevTime() throws 
	ConversionException, InvalidValueWarning, IOException, CalculationWarning {
		ESCSoundingRecord start = new ESCSoundingRecord();
		ESCSoundingRecord end = new ESCSoundingRecord();
		start.setTime(1.0);
	...
	@Override
	public void checkTimeValidCurrentValidNextNoPrevTimeEqual() throws ConversionException, InvalidValueWarning, IOException, CalculationWarning {
		ESCSoundingRecord start = new ESCSoundingRecord();
		ESCSoundingRecord end = new ESCSoundingRecord();
		start.setTime(1.0);
		end.setTime(1.0);
	...
	@Override
	public void checkTimeValidCurrentValidNextNoPrevTimeGreat() throws ConversionException, InvalidValueWarning, IOException, CalculationWarning {
		ESCSoundingRecord start = new ESCSoundingRecord();
		ESCSoundingRecord end = new ESCSoundingRecord();
		start.setTime(1.0);
		end.setTime(1.1);
		...
		assertEquals("Time Check - Value/Value/Null Great: start time", 1.0, start.getTime());
		assertEquals("Time Check - Value/Value/Null Great: end time", 1.1, end.getTime());
		assertEquals("Time Check - Value/Value/Null Great: prev time", 1.1, prevTime);
	}

	@Override
	public void checkTimeValidCurrentValidNextNoPrevTimeLess() throws ConversionException, InvalidValueWarning, IOException, CalculationWarning {
		ESCSoundingRecord start = new ESCSoundingRecord();
		ESCSoundingRecord end = new ESCSoundingRecord();
		start.setTime(1.0);
		end.setTime(0.9);
		...
		assertTrue("Time Check - Value/Value/Null Less: log ready - pre", 
				reader.ready());
		assertFalse("Time Check - Value/Value/Null Less: log output", 
				"".equals(reader.readLine()));
		assertFalse("Time Check - Value/Value/Null Less: log ready - post", 
				reader.ready());

		assertEquals("Time Check - Value/Value/Null Less: start time", 1.0, start.getTime());
		assertEquals("Time Check - Value/Value/Null Less: end time", 0.9, end.getTime());
		assertEquals("Time Check - Value/Value/Null Less: prev time", 0.9, prevTime);
	}

	@Override
	public void checkTimeValidCurrentValidNextValidPrevTimeEqual() throws ConversionException, InvalidValueWarning, IOException, CalculationWarning {
		ESCSoundingRecord start = new ESCSoundingRecord();
		ESCSoundingRecord end = new ESCSoundingRecord();
		start.setTime(1.0);
		end.setTime(1.0);
	...
	@Override
	public void checkTimeValidCurrentValidNextValidPrevTimeGreat() throws ConversionException, InvalidValueWarning, IOException, CalculationWarning {
		ESCSoundingRecord start = new ESCSoundingRecord();
		ESCSoundingRecord end = new ESCSoundingRecord();
		start.setTime(1.0);
		end.setTime(1.1);
		...
		assertFalse("Time Check - Value/Value/Value Great: log ready", 
				reader.ready());
	...
	@Override
	public void checkTimeValidCurrentValidNextValidPrevTimeLess() throws ConversionException, InvalidValueWarning, IOException, CalculationWarning {
		ESCSoundingRecord start = new ESCSoundingRecord();
		ESCSoundingRecord end = new ESCSoundingRecord();
		start.setTime(1.0);
		end.setTime(0.9);
		...
		assertTrue("Time Check - Value/Value/Value Less: log ready - pre", 
				reader.ready());
		assertFalse("Time Check - Value/Value/Value Less: log output", 
				"".equals(reader.readLine()));
		assertFalse("Time Check - Value/Value/Value Less: log ready - post", 
				reader.ready());

		assertEquals("Time Check - Value/Value/Value Less: start time", 1.0, start.getTime());
		assertEquals("Time Check - Value/Value/Value Less: end time", 0.9, end.getTime());
		assertEquals("Time Check - Value/Value/Value Less: prev time", 0.9, prevTime);
	}
