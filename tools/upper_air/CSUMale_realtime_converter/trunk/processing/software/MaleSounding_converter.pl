...
sub new {
    ...
    #----------------------------------------
    $rawDirName = "/net/work/Projects/dynamo/upper_air/Male_Maldives/processing/raw_data";      # test area
###  $rawDirName = "/net/iftp2/pub/incoming/dynamo/male";
    ...
    # Output directories. 
    #---------------------
    $outputDirName = "/net/work/Projects/dynamo/upper_air/Male_Maldives/processing/output";     # working dir
    $archiveDirName = "/net/work/Projects/dynamo/upper_air/Male_Maldives/processing/archive";   # archive copy of all CLS and log files

    $gtsDirName =  "/net/work/Projects/dynamo/upper_air/Male_Maldives/processing/gts";          # test area
###    $gtsDirName =  "/h/eol/iss/project/dyamo/data/male/cls";  # Final GTS area to place converted *.cls file
