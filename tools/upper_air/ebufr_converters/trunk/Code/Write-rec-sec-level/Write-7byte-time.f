C
C $Id: Write-7byte-time.f,v 1.1 1992/08/17 14:52:32 john Exp $
C $Log: Write-7byte-time.f,v $
C Revision 1.1  1992/08/17 14:52:32  john
C Initial
C
C

C Routine Long Name: Write-7byte-time
C  6 Character Name: WRT7BT
C           Purpose: To write the 7 byte time part of the fixed part
C                    of record 9 type EBUFR record.
C Import Parameters:
