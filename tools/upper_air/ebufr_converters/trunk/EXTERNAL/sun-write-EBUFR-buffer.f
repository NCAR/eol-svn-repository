C
C $Id: sun-write-EBUFR-buffer.f,v 1.2 1992/08/18 15:15:33 john Exp $
C $Log: sun-write-EBUFR-buffer.f,v $
C Revision 1.2  1992/08/18 15:15:33  john
...
C The following is a sun specific version of the routine to
C write an EBUFR record out to file.  See the user's guide
C for more information on what this routine does.
C  -------------------------------------------------
...
C ====================================================================
 ...
 20   CONTINUE 
      PRINT 6001,EUNIT
      STOP 2
 6001 FORMAT (1X, 'Error writing record to unit: ',I3/
     $        1X, 'Aborting program.')
      END
