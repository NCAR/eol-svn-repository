C
C $Id: ofps-getFXYU.f,v 1.1 1996/04/10 20:00:27 john Exp $
C $Log: ofps-getFXYU.f,v $
C Revision 1.1  1996/04/10 20:00:27  john
C Initial revision
C
...
C ====================================================================
      ...
      IF (ISCTAB) THEN
         WRITE(UNIT=FNAME,FMT=9998) XX,YY
      ELSE 
         WRITE(UNIT=FNAME,FMT=9997) XX,YY
      ENDIF
...
C     Format for flag tables
 9997 FORMAT ('flag_', I2.2,  '_', I3.3)

C     For code tables
 9998 FORMAT ('code_', I2.2,  '_', I3.3)
