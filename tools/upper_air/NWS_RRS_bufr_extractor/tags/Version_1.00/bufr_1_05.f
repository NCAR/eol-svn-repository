...
C.KRK      PRINT*
      ...
      PRINT*,'************************ABORT**************************'
      PRINT*
      call abort()  ! Added by LJG for IBM RISC/6000
c
c  THE FOLLOWING 7 LINES WERE COMMENTED OUT BY Larry Griffin AT NCDC TO
c  MAKE IT COMPATIBLE FOR IBM RISC/6000.
c
C.LJG      CHARACTER*8 CCYYMMDD
C.LJG      CHARACTER*6 HHMMSS
C.LJG      CALL DATE_AND_TIME (CCYYMMDD, HHMMSS)
C.LJG      OPEN (51,FILE='BUFR-err.log',ACTION='WRITE',POSITION='APPEND')
C.LJG      WRITE(51,*) CCYYMMDD//' '//HHMMSS//' '//STR
C.LJG      CLOSE(51)
C.LJG      CALLEXIT(49)                                                          
      END                                                               
