...
my $networks;
$networks->{"C130"} = "/work/RICO/upperair/dropsonde/EOL_aircraft/final";
$networks->{"GAUS"} = "/work/RICO/upperair/upsonde/GAUS/final";
$networks->{"NWS"} = "/work/RICO/upperair/upsonde/NWS/final";
$networks->{"seward_johnson"} = "/work/RICO/upperair/upsonde/RV_seward_johnson/final";

# The project time of interest dates
my $START_DATE = "20041201";
my $END_DATE = "20050131";
