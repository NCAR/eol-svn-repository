...
public class ActualTimeCheckStateTest {

	private ActualTimeCheckState state;
	...
	@Before public void setUp() throws IOException {
		...
		state = new ActualTimeCheckState(reader, "", 5);
		store = new DataStore();
	}
	
	@Test public void correctActualTimeLine() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 07, 09, 13:31:54", 5, store, log);
		assertFalse("Correct Actual Time Line: ready", reader.ready());
	}
	
	@Test public void incorrectLabel() throws IOException {
		state.executeLineCheck("GMT Release Time (y,m,d,h,m,s):    2007, 07, 09, 13:31:54", 5, store, log);
		assertTrue("Incorrect Label: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("Incorrect Label: actual release label", line.contains("'Actual Release' label"));
		assertTrue("Incorrect Label: expected output", line.contains("UTC Release Time (y,m,d,h,m,s):"));
	}
	...
	@Test public void missingColon() throws IOException {
		...
		String line = reader.readLine();
		assertTrue("Missing Colon: actual release label", line.contains("'Actual Release' label"));
		assertTrue("Missing Colon: expected output", line.contains("UTC Release Time (y,m,d,h,m,s):"));
	}
	...
	@Test public void noPaddingAfterLabel() throws IOException {
		...
		String line = reader.readLine();
		assertTrue("No Padding: actual release label", line.contains("'Actual Release' label"));
		assertTrue("No Padding: expected output", line.contains("UTC Release Time (y,m,d,h,m,s):"));
	}
	...
	@Test public void tooLittlePaddingAfterLabel() throws IOException {
		...
		String line = reader.readLine();
		assertTrue("Too Little Padding: actual release label", line.contains("'Actual Release' label"));
		assertTrue("Too Little Padding: expected output", line.contains("UTC Release Time (y,m,d,h,m,s):"));
	}
	...
	@Test public void tooMuchPaddingAfterLabel() throws IOException {
		...
		String line = reader.readLine();
		assertTrue("Too Much Padding: actual release", line.contains("'Actual Release'"));
	...
	@Test public void twoDigitYear() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    07, 07, 09, 13:31:54", 5, store, log);
		assertTrue("2 Digit Year: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("2 Digit Year: actual release", line.contains("'Actual Release'"));
	...
	@Test public void nonNumericYear() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2x07, 07, 09, 13:31:54", 5, store, log);
		assertTrue("Non-Numeric Year: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("Non-Numeric Year: actual release", line.contains("'Actual Release'"));
	...
	@Test public void oneDigitMonth() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 7, 09, 13:31:54", 5, store, log);
		assertTrue("1 Digit Month: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("1 Digit Month: actual release", line.contains("'Actual Release'"));
	...
	@Test public void illegalMonth() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 13, 09, 13:31:54", 5, store, log);
		assertTrue("Illegal Month: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("Illegal Month: actual release", line.contains("'Actual Release'"));
	...
	@Test public void nonNumericMonth() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 0x, 09, 13:31:54", 5, store, log);
		assertTrue("Non-Numeric Month: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("Non-Numeric Month: actual release", line.contains("'Actual Release'"));
	...
	@Test public void oneDigitDay() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 07, 9, 13:31:54", 5, store, log);
		assertTrue("1 Digit Day: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("1 Digit Day: actual release", line.contains("'Actual Release'"));
	...
	@Test public void illegalDay() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 07, 00, 13:31:54", 5, store, log);
		assertTrue("Illegal Day: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("Illegal Day: actual release", line.contains("'Actual Release'"));
	...
	@Test public void nonNumericDay() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 07, 0x, 13:31:54", 5, store, log);
		assertTrue("Non-Numeric Day: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("Non-Numeric Day: actual release", line.contains("'Actual Release'"));
	...
	@Test public void oneDigitHour() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 07, 9, 1:31:54", 5, store, log);
		assertTrue("1 Digit Hour: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("1 Digit Hour: actual release", line.contains("'Actual Release'"));
	...
	@Test public void illegalHour() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 07, 00, 24:31:54", 5, store, log);
		assertTrue("Illegal Hour: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("Illegal Hour: actual release", line.contains("'Actual Release'"));
	...
	@Test public void nonNumericHour() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 07, 09, x3:31:54", 5, store, log);
		assertTrue("Non-Numeric Hour: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("Non-Numeric Hour: actual release", line.contains("'Actual Release'"));
	...
	@Test public void oneDigitMinute() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 07, 9, 13:3:54", 5, store, log);
		assertTrue("1 Digit Minute: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("1 Digit Minute: actual release", line.contains("'Actual Release'"));
	...
	@Test public void illegalMinute() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 07, 00, 13:60:54", 5, store, log);
		assertTrue("Illegal Minute: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("Illegal Minute: actual release", line.contains("'Actual Release'"));
	...
	@Test public void nonNumericMinute() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 07, 09, 13:3x:54", 5, store, log);
		assertTrue("Non-Numeric Minute: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("Non-Numeric Minute: actual release", line.contains("'Actual Release'"));
	...
	@Test public void oneDigitSecond() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 07, 9, 13:31:5", 5, store, log);
		assertTrue("1 Digit SEcond: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("1 Digit Second: actual release", line.contains("'Actual Release'"));
	...
	@Test public void illegalSecond() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 07, 00, 13:31:60", 5, store, log);
		assertTrue("Illegal Second: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("Illegal Second: actual release", line.contains("'Actual Release'"));
	...
	@Test public void nonNumericSecond() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007, 07, 09, 13:31:5x", 5, store, log);
		assertTrue("Non-Numeric Second: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("Non-Numeric Second: actual release", line.contains("'Actual Release'"));
	...
	@Test public void illegalYearMonthSeparator() throws IOException {
		state.executeLineCheck("UTC Release Time (y,m,d,h,m,s):    2007/07, 09, 13:31:53", 5, store, log);
		assertTrue("Illegal Year-Month Separator: ready", reader.ready());
		String line = reader.readLine();
		assertTrue("Illegal Year-Month Separator: actual release", line.contains("'Actual Release'"));
	...
	@Test public void illegalMonthDaySeparator() throws IOException {
		...
		String line = reader.readLine();
		assertTrue("Illegal Month-Day Separator: actual release", line.contains("'Actual Release'"));
	...
	@Test public void illegalDayHourSeparator() throws IOException {
		...
		String line = reader.readLine();
		assertTrue("Illegal Day-Hour Separator: actual release", line.contains("'Actual Release'"));
	...
	@Test public void illegalHourMinuteSeparator() throws IOException {
		...
		String line = reader.readLine();
		assertTrue("Illegal Hour-Minute Separator: actual release", line.contains("'Actual Release'"));
	...
	@Test public void illegalMinuteSecondSeparator() throws IOException {
		...
		String line = reader.readLine();
		assertTrue("Illegal Minute-Second Separator: actual release", line.contains("'Actual Release'"));
	...
	@Test public void trailingWhiteSpace() throws IOException {
		...
		String line = reader.readLine();
		assertTrue("Trailing Whitespace: actual release", line.contains("'Actual Release'"));
	...
	@Test public void lineNumberTooSmall() throws IOException {
		...
		assertTrue("Too Small Line Number: log read", reader.readLine().contains(" expected on line 5"));
	}
	...
	@Test public void lineNumberTooBig() throws IOException {
		...
		assertTrue("Too Big Line Number: log read", reader.readLine().contains(" expected on line 5"));
	}
}
