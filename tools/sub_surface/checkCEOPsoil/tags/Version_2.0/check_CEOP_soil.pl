...
#HERE
         ...
         {
         print "      ERROR DATA: Parameter Flag ($parm_flag) at position $position is NOT a legal (value (i.e., U,G,D,B,I) for a NON-MISSING Value at line $num
ber_lines_processed in $input_file_name.\n";  $err++; $err_data++; $parm_positions{$parm}{ERR_CT}++;
