...
sub write_output_tower_line {
    ...
    #--------------------------
    printf OUTFILE_JOSSCorrected ("%10s %5s %10s %5s %-10s %-15s %-15s %10.5f %11.5f %7.2f %7.2f %7.2f %s %7.2f %s %7.2f %s %7.2f %s %7.2f %s %7.2f %s %7.2f %s %7.2f %s %7.2f %s\n",
    $meta_parts[0], $meta_parts[1], $meta_parts[2], $meta_parts[3],
    $meta_parts[4], $meta_parts[5], $meta_parts[6], $meta_parts[7],
    $meta_parts[8], $meta_parts[9], $meta_parts[10],
...
sub write_output_flux_line {
    ...
    # Print Dates through elevation.
    printf OUTFILE_JOSSCorrected ("%10s %5s %10s %5s %-10s %-15s %-15s %10.5f %11.5f %7.2f %7.2f %8.2f %s %8.2f %s %8.2f %s %8.2f %s\n",
    $meta_parts[0], $meta_parts[1], $meta_parts[2], $meta_parts[3],
    $meta_parts[4], $meta_parts[5], $meta_parts[6], $meta_parts[7],
    $meta_parts[8], $meta_parts[9], $meta_parts[10],
    $data_parts[0], $data_parts[1], $data_parts[2], $data_parts[3],
...
sub write_output_soils_line {
    ...
    # Print Meta data and data.
    printf OUTFILE_JOSSCorrected ("%10s %5s %10s %5s %-10s %-15s %-15s %10.5f %11.5f %7.2f %7.2f %8.2f %s %8.2f %s\n",
    $meta_parts[0], $meta_parts[1], $meta_parts[2], $meta_parts[3],
    $meta_parts[4], $meta_parts[5], $meta_parts[6], $meta_parts[7],
    $meta_parts[8], $meta_parts[9], $meta_parts[10],
    $data_parts[0], $data_parts[1], $data_parts[2], $data_parts[3]);
