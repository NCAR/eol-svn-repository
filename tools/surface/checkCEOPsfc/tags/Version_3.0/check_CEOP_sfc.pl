...
#
#HERE
#   Execute: check_CEOP_sfc.pl CSE_RefSite_Stn_bdate_edate.sfc 0 30
#
#   Required Inputs: Three input parameters are required as shown below:
#
#      check_CEOP_sfc.pl input_file_name info_level data_frequency
#
...
#   The default info_level is 0. [data_frequency] is the frequency of
#   of the data in minutes (e.g., 30 for 30 minute data, 60 for hourly, etc.).
#
#   E.g., check_CEOP_sfc.pl LBA_Pantanal_Pantanal_20020701_20020701.sfc 2 30
#
...
#HERE
# Apr 2004 lec Version 3
#   Add in time checks to ensure time gaps are flagged. 
#   Since source data may not be sorted properly, must check times 
#   from sorted file if it was created.
#------------------------------------------------------------------------
# HARDCODED
#
