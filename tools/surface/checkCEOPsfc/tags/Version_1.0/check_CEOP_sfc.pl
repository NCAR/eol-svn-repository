...
sub parse_record_data {
   ...
   %flag_count = (
      ...
      "precip"             => {C=>0,M=>0,B=>0,I=>0,D=>0,G=>0,U=>0,UNKNOWN=>0},
      "snow_depth"         => {C=>0,M=>0,B=>0,I=>0,D=>0,G=>0,U=>0,UNKNOWN=>0},
      "incoming_shortwave" => {C=>0,M=>0,B=>0,I=>0,D=>0,G=>0,U=>0,UNKNOWN=>0},
      "outgoing_shortwave" => {C=>0,M=>0,B=>0,I=>0,D=>0,G=>0,U=>0,UNKNOWN=>0},
      "incoming_longwave"  => {C=>0,M=>0,B=>0,I=>0,D=>0,G=>0,U=>0,UNKNOWN=>0},
      "outgoing_longwave"  => {C=>0,M=>0,B=>0,I=>0,D=>0,G=>0,U=>0,UNKNOWN=>0},
      "net_radiation"      => {C=>0,M=>0,B=>0,I=>0,D=>0,G=>0,U=>0,UNKNOWN=>0},
      "skin_temp"          => {C=>0,M=>0,B=>0,I=>0,D=>0,G=>0,U=>0,UNKNOWN=>0},
      "incoming_PAR"       => {C=>0,M=>0,B=>0,I=>0,D=>0,G=>0,U=>0,UNKNOWN=>0},
      "outgoing_PAR"       => {C=>0,M=>0,B=>0,I=>0,D=>0,G=>0,U=>0,UNKNOWN=>0}
     );                               
