...
# Oct 2004 lec Version 5
#     - Incremented $PROJECT_YEAR_NEXT to include the next 2 years to
#       cover EOP4, too.
# Aug 2007 lec Version 6 
#     - Incremented $PROJECT_YEAR_NEXT to include the next 4 years to
#       cover 2005 and 2006 for CEOP/Phase 2.
# Feb 2009 lec Version 7 
#     - Incremented $PROJECT_YEAR_NEXT to include the next 5 years to
#       cover through 2007 for CEOP/Phase 2.
# Nov 2010 lec Version 8
#     - Incremented $PROJECT_YEAR_NEXT to include through year 2010.
#------------------------------------------------------------------------
# HARDCODED
#
# CEOP EOP-3 runs 1 Oct 2002 thru 30 Sept 2003
# CEOP EOP-4 runs 1 Oct 2003 thru 30 Sept 2004
# CEOP Phase 2 picks up years 2005 through 2007
#-------------------------------------------------------
$PROJECT_YEAR = 2002;                   # HARDCODED to EOP-3
$PROJECT_YEAR_NEXT = $PROJECT_YEAR + 8; # HARDCODED to include 2010 data.
