...
#if QC_STNPRS
               /* -- Station Pressure. -- */
               if (qcfptr->staprs >0.00 && qcfptr->staflg != 'B') /*HERE*/
                  {
...
/* #if DEBUG */
               ...
               if (current_qcfptr->cmpflg !='M' && current_qcfptr->cmpflg !='N' &&
                  ...
                  if (current_qcfptr->staflg !='M' && current_qcfptr->staflg !='N' &&
                     ...
                     {
                     if (current_qcfptr->staflg != 'E' && current_qcfptr->staflg != 'D') /*HERE*/
