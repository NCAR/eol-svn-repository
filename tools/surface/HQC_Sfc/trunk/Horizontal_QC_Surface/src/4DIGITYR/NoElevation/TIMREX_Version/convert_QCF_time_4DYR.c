 ...
 * Sep 2009 lec
 *   Added TIMREX networks temporarily for their surface testing.
 *   This is the first time that positive lats have been ever tested.
 *--------------------------------------------------------------------*/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
char *argv[];
   ...
   struct {char  network[11]; int  freq;} network_freq[ MAX_NETWORKS] = { 
                              ...
                              {  "RWIS_SD   \0",  60},/*60min*/
                              {  "TNRCC     \0",  60},/*60min*/
                              {  "CWB-sfc   \0",   1},/*1min - TIMREX*/
                              {  "NCU-ISS   \0",   1},/*1min - TIMREX*/
                              {  "NCU-MAWS  \0",   1},/*1min - TIMREX*/
                              {  "NCU-MAWs  \0",   1},/*1min - TIMREX*/
                              {  "NCU-TOW   \0",   1},/*1min - TIMREX*/
                              {  "pccu-maws \0",   1},/*1min - TIMREX*/
