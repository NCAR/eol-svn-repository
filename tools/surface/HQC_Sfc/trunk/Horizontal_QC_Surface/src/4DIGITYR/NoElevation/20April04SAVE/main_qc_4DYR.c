...
/*                if (jj == 0)
                   ...
                   * Only reset Estimated flags (E) if
                   * HQC determines value is Bad (B).
                   *-------------------------------------*/
...
/* #if ALWAYS_PRINT  */
                     ...
                     * Only override Estimated if QC finds value Bad.
                     *-----------------------------------------------*/
                    switch (jj) {
                       case 0:
                         if (source_qcflag != 'E')
                       ...
                       case 6:
                         ...
                         else /* Wind Direction estimated */
                            {
                            if (current_qcfptr->wndspd >= 10.0 && qcflag == 'B')
                               current_qcfptr->dirflg = qcflag; 
                            else
                               /* Else don't reset the value. Leave it Estimated. */
               ...
               if (current_qcfptr->cmpflg !='M' && current_qcfptr->cmpflg !='N' &&
                  ...
                  if (current_qcfptr->staflg !='M' && current_qcfptr->staflg !='N' &&
                     ...
                     {
                     if (current_qcfptr->staflg != 'E')
                        current_qcfptr->staflg = current_qcfptr->cmpflg;
                     else
                        { /* Only overwrite E with B */
...
#if DEBUG2
                     printf ("LOGICAL: Reset Stn pressure QC flags using Sea Lvl P qcflag!!\n");  
#endif  
                     }
