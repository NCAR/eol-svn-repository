 ...
 * 15 Mar 2007 lec
 *   Updated to read QCinit.inp file that now includes
 *   Max delta elevation used in QC.
 *-------------------------------------------------------*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
char *argv[];
   ...
   STRIPLINE(init_input_stream);                /*Skip min_weight - Area of Influence */
   STRIPLINE(init_input_stream);                /*Skip max delta elev */
