...
char *argv[];
   ...
   open_file (max_output_file_name, "w", &max_output_stream);
   open_file (min_output_file_name, "w", &min_output_stream);
   open_file (ave_output_file_name, "w", &ave_output_stream);
