...
C************************************************************************
      ...
      integer*2 function getqcfrec_4DYR()
...
100   read(unit_qcf,1002,iostat=ios,err=901,end=900) qcfbuf
     ...
     +     qcf.cc(3).ceilhgt,qcf.cc(3).ceilflg,qcf.cc(3).ceilqc,
     +     qcf.cc(3).cldamt,qcf.cc(3).cldqc
	    write(0,*) ' getqcfrec_4DYR: Continue?'
         accept 1005, yn
      end if
      goto 999
900   getqcfrec_4DYR = -2
      goto 999
901   errstr=gerror(errstr)
      write(0,*) 'getqcfrec_4DYR(): I/O Error: ',ios,' ',errstr
      write(0,*) 'qcfbuf=',qcfbuf
999   return
1001  format(a4,'/',a2,'/',a2,1x,a2,':',a2,1x,a10,1x,a15,1x,f10.5,
...
C1002  format(a255)	!This must be equal to length of the qcf record
