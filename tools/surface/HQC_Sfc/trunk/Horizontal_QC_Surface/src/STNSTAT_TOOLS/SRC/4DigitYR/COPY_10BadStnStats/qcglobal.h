...
C 16 Aug 95 lec
C   Modified pathnames, FIRSTDAY and LASTDAY parameter for Microfronts.
C 20 Oct 95 lec
C   Modified pathnames, FIRSTDAY and LASTDAY parameter for VORTEX 95
C   and STORMWAVE.
C 09 May 96 lec
C   Modified pathnames, FIRSTDAY and LASTDAY parameter for
C   ESOP 95.
C 12 Aug 96 lec
C   Modified MAXPLATFORM parameter for ESOP 95 which has approx.
C   15 different sfc platforms.
C 04/25 Mar 97 lec
C   Modified FIRSTDAY and LASTDAY parameter for ESOP 96 (leap yr)
C   and MAXSTNS to 2000.
C 21 Oct 2003 lec
C   Increased MAXPLATFORM parameter to 50 for IHOP.
C 28 Jun 2004 lec
C   Increased MAXPLATFORM parameter to 80 and MAXSTNS to 3000 for BAMEX.
C*********************************************************************
...
C
     ...
     +           unit_anal  =7)		!qc analyses file unit
      ...
      character*60 qc_0qc  			!0qc input file
      character*60 qc_qcf		 	!qcf output file
      character*60 qc_var    			!qcf variance file
      character*60 qc_toss   			!qcf toss file
      character*60 qc_stns   			!station master input file
      character*60 qc_stns2  			!station master output file
      character*60 qc_config			!qc config file
      character*60 qc_anal			!MAPS file directory
...
C  GIST   period (1Apr94 thru 31Aug94)
C  MICROFRONTS  period (15Feb95 thru 31Mar95)
C  VORTEX 95  period (1Apr95 thru 15Jun95) 
C  STORMWAVE  period (1Apr95 thru 30Jun95) 
C  ESOP 95    period (1Apr95 thru 30Sep95) 
C  GCIP/ESOP 96  period (1Apr96 thru 30Sep96) 
C  GCIP/ESOP 97 & 98 & LakeICE covered by OctYY thru MayYY+1
C     Set to list and consider all days.
C
     ...
     +		 NQCFLAGS=9,	  !number of possible qc flags
     +           MAXPLATFORM=80,  !max no. of unique platforms - was 10,11,20
     +           MAXSTNS=3000,    !max no. of unique stations (all platforms)
     +           FIRSTDAY=1,      !first day of field program (Julian Day) GIST 91;ES95=91
     +           LASTDAY=366)     !last day of field program (Julian Day) GIST 243;ES95=273
