...
#   to redo the 1995 ESOP and 1995 STORM-WAVE 15min and hrly
#   precip composites.
# 
# 97 Sep lec
#   Created.
...
#
# Only set one of the following to true (1)
...
if ($ESOP_DATA)
   ...
   {
   print "NOT - Processing ESOP data\n";
   } 

if ($STORMWAVE_DATA) 
   {
   print "Processing STORMWAVE data\n";
   } 
else 
   { 
   print "NOT - Processing STORMWAVE data\n";
   }  
