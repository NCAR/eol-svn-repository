...
char *argv[];
   ...
   printf ("Combining %-s with %-s to form %-s\n",
           input_file1_name, input_file2_name, sigma_output_file_name);


   /*-----------------------------------------------
    * Open input/output files.
    *----------------------------------------------*/
   open_file (input_file1_name, "r", FILE_COMPRESSED, &input_stream1);
   open_file (input_file2_name, "r", FILE_COMPRESSED, &input_stream2);
   ...
   close_file (&input_stream1, FILE_COMPRESSED);
   close_file (&input_stream2, FILE_COMPRESSED);
