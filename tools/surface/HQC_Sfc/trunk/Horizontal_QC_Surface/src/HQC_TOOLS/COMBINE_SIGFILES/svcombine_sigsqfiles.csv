...
char *argv[];
    ...
    *----------------------------------------------*/
   open_file (input_file1_name, "r", FILE_NOT_COMPRESSED, &input_stream1);
   open_file (input_file2_name, "r", FILE_NOT_COMPRESSED, &input_stream2);
   ...
   close_file (&input_stream1, FILE_NOT_COMPRESSED);
   close_file (&input_stream2, FILE_NOT_COMPRESSED);
