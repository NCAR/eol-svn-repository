...
#-------------------------------------------------------
# remove_ALL_abrfc.pl - This perl script/program reads PQCF
...
printf "\n-----remove_ALL_abrfc.pl began at $year/$mon/$mday $hour:$min:$sec\n";
...
($sec,$min,$hour,$mday,$mon,$year,$wday,$yday,$isdst) = localtime(time);
printf "-----remove_ALL_abrfc.pl ended at $year/$mon/$mday $hour:$min:$sec\n\n";
