...
#-------------------------------------------
# Create a list of requested occ settings.
#-------------------------------------------
#@occ_settings = ("AWOSH20    ADH               34.80000   -96.67000   0",
#                 "ASOS5      MLC               34.88000   -95.78000   0");
...
while ($line = <INFILE>) 
   ...
   $occ = 0;
#
# Use following check for SW 20MIN composite.
#
#   if ( $stn_info eq "AWOSH20    ADH               34.80000   -96.67000   0")

# 
# Use following check for SW 5MIN composite. 
# 
