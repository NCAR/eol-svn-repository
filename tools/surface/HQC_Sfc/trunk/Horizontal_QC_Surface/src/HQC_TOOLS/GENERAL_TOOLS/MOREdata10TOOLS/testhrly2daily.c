			...
			case 2:
				...
				if (accum == 1 && static_accum == 1)
				{
					...
					static_accum = 0;
                                	...
                                	/*
					 * Check rest of day. Set static accum properly.
					 */
					for (kk=i; kk<24; kk++)
					   {
	                                   printf ("Check for another accum period in this day. kk= %d\n",kk);

                                           if (hrly->obs[kk].code_flag == 1)
                                              {
	                                      printf ("Found another accum period - static_accum=1\n");
                                              static_accum = 1;
                                              }
					   } /* for kk */
