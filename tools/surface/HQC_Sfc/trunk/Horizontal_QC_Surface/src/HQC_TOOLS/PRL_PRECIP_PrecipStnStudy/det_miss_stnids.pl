...
open (OUTFILE, ">stns_not_in_list.out") || die "Can NOT open output file for writing";
open (OUTFILE2, ">stns_totalUniq_in_nwsli.out") || die "Can NOT open output2 file for writing";
...
#   This info is from the stn list sent by with
#   the data (i.e., nwsli.uniq).
#-----------------------------------------------
...
# NOT in given list. These stn IDs
# are from the data. This is a 
# unique list of all the IDs from
# both the Daily and Hourly gage
# data sent by Sid Katz. The user
# had to have previously created
# this list. (stnids) Search for
# each of these IDs in the given
# station list (nwsli.uniq).
#----------------------------------
$i = 0;
