...
#------------------------------------------------------------
# set_LKICE_60min_occ.pl - This perl script/program reads QCF
...
printf "\nset_LKICE_60min_occ.pl began at $year/$mon/$mday $hour:$min:$sec\n";
...
($sec,$min,$hour,$mday,$mon,$year,$wday,$yday,$isdst) = localtime(time);
printf "set_LKICE_60min_occ.pl ended at $year/$mon/$mday $hour:$min:$sec\n";
