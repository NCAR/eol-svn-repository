...
sub create_web_page {
   ...
   while ($input_line = <DIST_INPUT_FILE>)
      ...
      if ( $number_lines_processed != 1 && $number_lines_processed != 2 && $number_lines_processed != 3 &&
         ...
         $line_section1 = substr($CD_line,0,54);
         @new_line_parts = split ' ', $line_section1;
         $CD_stnID = $new_line_parts[0];
         $CD_lat = $new_line_parts[2];
         $CD_lon = $new_line_parts[3];
...
###was:  printf DIST_OUTPUT_FILE "<b><font color=blue>StnFileLineNum.</font>Current_Station (lat/lon location): &nbsp;&nbsp;&nbsp;<font color=blue>$current_stn</font></b><br>\n";
         ...
         foreach $station_combo (@compared_stations)
            ...
            $line_section1 = substr($CD_line,0,54);
            @line_parts = split ' ', $line_section1;
            $CD_stnID = $line_parts[0];
            $CD_lat = $line_parts[2];
            $CD_lon = $line_parts[3];
            ...
            if ($num == 1) #First is always "Found xx stations within...."
               ...
               if ($number_printed < $NUMBER_STNS_TO_PRINT)
                  ...
                  if ($num ==2) 
                     ...
                     printf DIST_OUTPUT_FILE "<th>StnID</th>\n";
                     printf DIST_OUTPUT_FILE "<th>Distance (KM)</th>\n";
                     printf DIST_OUTPUT_FILE "<th>Lat</th>\n";
                     printf DIST_OUTPUT_FILE "<th>Lon</th>\n";
                     printf DIST_OUTPUT_FILE "<th>Elev</th>\n";
                     printf DIST_OUTPUT_FILE "<th>Frequency</th>\n";
                     printf DIST_OUTPUT_FILE "<th>Platform</th>\n";
                     printf DIST_OUTPUT_FILE "<th>Name</th>\n";
                     printf DIST_OUTPUT_FILE "</tr> \n";

                     printf DIST_OUTPUT_FILE "<tr> <td><b><font color=red>$stnInfo{$DIST}{STNID} </font></b></td> <td><b><font color=red>$stnInfo{$DIST}{DISTANCE}</font></b></td> <td><b><font color=red>$stnInfo{$DIST}{LAT}</font></b></td> <td><b><font color=red>$stnInfo{$DIST}{LON}</font></td> <td><b><font color=red>$stnInfo{$DIST}{ELEV}</font></b></td> <td><b><font color=red>$stnInfo{$DIST}{FREQ}</font></b></td> <td><b><font color=red>$stnInfo{$DIST}{NETWORK}</font></b></td> <td><b><font color=red>$stnInfo{$DIST}{NAME}</font></b> </td> </tr>\n";
                     }
                  elsif ($DIST<=10) 
                    {
                     printf DIST_OUTPUT_FILE "<tr> <td><b><font color=orange>$stnInfo{$DIST}{STNID}</font></b></td> <td><b><font color=orange>$stnInfo{$DIST}{DISTANCE}</font></b></td> <td><b><font color=orange>$stnInfo{$DIST}{LAT}</font></b></td> <td><b><font color=orange>$stnInfo{$DIST}{LON}</font></td> <td><b><font color=orange>$stnInfo{$DIST}{ELEV}</font></b></td> <td><b><font color=orange>$stnInfo{$DIST}{FREQ}</font></b></td> <td><b><font color=orange>$stnInfo{$DIST}{NETWORK}</font></b></td> <td><b><font color=orange>$stnInfo{$DIST}{NAME}</font></b> </td> </tr>\n";
                    }
                  elsif ($DIST<=25) 
                    {
                     printf DIST_OUTPUT_FILE "<tr> <td><b><font color=yellowgreen>$stnInfo{$DIST}{STNID} </font></b></td> <td><b><font color=yellowgreen> $stnInfo{$DIST}{DISTANCE}</font></b></td> <td><b><font color=yellowgreen>$stnInfo{$DIST}{LAT}</font></b></td> <td><b><font color=yellowgreen>$stnInfo{$DIST}{LON}</font></td> <td><b><font color=yellowgreen>$stnInfo{$DIST}{ELEV}</font></b></td> <td><b><font color=yellowgreen>$stnInfo{$DIST}{FREQ}</font></b></td> <td><b><font color=yellowgreen>$stnInfo{$DIST}{NETWORK}</font></b></td> <td><b><font color=yellowgreen>$stnInfo{$DIST}{NAME}</font></b> </td> </tr>\n";
                    }
                  elsif ($DIST<=50) 
                    {
                     printf DIST_OUTPUT_FILE "<tr> <td><b><font color=green>$stnInfo{$DIST}{STNID}</font></b></td> <td><b><font color=green> $stnInfo{$DIST}{DISTANCE}</font></b></td> <td><b><font color=green>$stnInfo{$DIST}{LAT}</font></b></td> <td><b><font color=green>$stnInfo{$DIST}{LON}</font></td> <td><b><font color=green>$stnInfo{$DIST}{ELEV}</font></b></td> <td><b><font color=green>$stnInfo{$DIST}{FREQ}</font></b></td> <td><b><font color=green>$stnInfo{$DIST}{NETWORK}</font></b></td> <td><b><font color=green>$stnInfo{$DIST}{NAME}</font></b> </td> </tr>\n";
                    }
                  elsif ($DIST<=75) 
                    {
                     printf DIST_OUTPUT_FILE "<tr> <td><b><font color=blue>$stnInfo{$DIST}{STNID}</font></b></td> <td><b><font color=blue> $stnInfo{$DIST}{DISTANCE}</font></b></td> <td><b><font color=blue>$stnInfo{$DIST}{LAT}</font></b></td> <td><b><font color=blue>$stnInfo{$DIST}{LON}</font></td> <td><b><font color=blue>$stnInfo{$DIST}{ELEV}</font></b></td> <td><b><font color=blue>$stnInfo{$DIST}{FREQ}</font></b></td> <td><b><font color=blue>$stnInfo{$DIST}{NETWORK}</font></b></td> <td><b><font color=blue>$stnInfo{$DIST}{NAME}</font></b> </td> </tr>\n";
                    }
                  elsif ($DIST<=100) 
                    {
                     printf DIST_OUTPUT_FILE "<tr> <td><b><font color=purple>$stnInfo{$DIST}{STNID} </font></b></td> <td><b><font color=purple> $stnInfo{$DIST}{DISTANCE}</font></b></td> <td><b><font color=purple>$stnInfo{$DIST}{LAT}</font></b></td> <td><b><font color=purple>$stnInfo{$DIST}{LON}</font></td> <td><b><font color=purple>$stnInfo{$DIST}{ELEV}</font></b></td> <td><b><font color=purple>$stnInfo{$DIST}{FREQ}</font></b></td> <td><b><font color=purple>$stnInfo{$DIST}{NETWORK}</font></b></td> <td><b><font color=purple>$stnInfo{$DIST}{NAME}</font></b> </td> </tr>\n";
                    }
                  else 
                    {
                     printf DIST_OUTPUT_FILE "<tr> <td><b><font color=black>$stnInfo{$DIST}{STNID} </font></b></td> <td><b><font color=black>$stnInfo{$DIST}{DISTANCE}</font></b></td> <td><b><font color=black>$stnInfo{$DIST}{LAT}</font></b></td> <td><b><font color=black>$stnInfo{$DIST}{LON}</font></td> <td><b><font color=black>$stnInfo{$DIST}{ELEV}</font></b></td> <td><b><font color=black>$stnInfo{$DIST}{FREQ}</font></b></td> <td><b><font color=black>$stnInfo{$DIST}{NETWORK}</font></b></td> <td><b><font color=black>$stnInfo{$DIST}{NAME}</font></b> </td> </tr>\n";
                    } #num or DIST check
