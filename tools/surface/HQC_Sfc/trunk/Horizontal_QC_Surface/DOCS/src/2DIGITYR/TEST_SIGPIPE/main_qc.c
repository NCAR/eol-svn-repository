...
int main( int argc, char *argv[])
   ...
   /*---------------------------------------
    * Compute length of project in days.
    *--------------------------------------*/
   project_length = end_YYYYJJJ - begin_YYYYJJJ;

 
#if  ALWAYS_PRINT
   printf ("proj_begin_date, proj_end_date, begin_date, end_date: %-s %-s %-s %-s\n",
            proj_begin_date, proj_end_date, begin_date, end_date);

   printf ("proj_begin_YYYYJJJ, proj_end_YYYYJJJ, begin_YYYYJJJ, end_YYYYJJJ, end_sigma_period_date, project_length: %ld %ld %ld %ld %ld %ld\n",
           proj_begin_YYYYJJJ, proj_end_YYYYJJJ, begin_YYYYJJJ, end_YYYYJJJ, 
           end_sigma_period_date, project_length);
#endif
...
/* #if DEBUG */
                        ...
                        printf ("for parmeter, stn_no, stn: %d %d %-s\n",         
