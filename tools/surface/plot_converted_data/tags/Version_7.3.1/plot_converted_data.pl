...
#
# It turns out that having the : and / handling in the same subroutine
# doesn't work. Subsequently, I did a quick mod to the code to handle :'s,
# which created this version of the code. This version does NOT handle /.
# See version 7.6 for a complete version than handles both.  That is why
# this code is not saved to the main revision tree.
#
...
"\\\\\\\"< tr 'X' '1' < ${infile} \\\\\\\" using 1\\\:(\\\$$column{$param}*(\\\$$flag == 1 )) title \\\\\\\"glitch\\\\\\\" with points 8 12,";} # orange
                                        ...
                                        $plotspec =~ s/,$//;
                                        my $color= "color"; 
        my $ps_file_esc = &escape_chars($ps_file);
        my $plotspec_esc = &escape_chars($plotspec);
