...
sub createEquationTable {
    ...
    $table .= sprintf("<tr><td class=equation><iframe src=\"http://dmg.eol.ucar.edu/software/tools/web/conversions/%s\">If internal frames do not work, click <a href=\"javascript: openwindow('http://dmg.eol.ucar.edu/software/tools/web/conversions/%s')\">here</a> to see the equation.</iframe></td></tr>\n",$self->getEquationPage(),$self->getEquationPage());
...
##------------------------------------------------------------------------------------------
sub getLastEditDate { return "Sept 21 2007"; }

##------------------------------------------------------------------------------------------
# @signature String getLastEditor()
...
sub getNotes {
    my $self = shift;
    my $notes = "<p class=notes>This script uses the most recent update of the Perl conversion modules.  For more information on the modules, go <a href=".">here</a>.</p>\n";
...
##------------------------------------------------------------------------------------------
sub getStyleSheet { return "http://dmg.eol.ucar.edu/software/tools/web/conversions/conv.css"; }
...
sub makePage {
    ...
    printf("\n<!-- Form -->\n<div id=dataform>\n");
    printf("<form method=POST action=/cgi-bin/conversions/%s",
	   $web->getCGI());
