...
sub main() {
    ...
    print $cgi->header();
    print "<html><head><title>DocPerl</title>\n";
    print "<link rel=\"STYLESHEET\" type=\"text/css\"";
    print "href=\"http://www.joss.ucar.edu/dpg/TOOLS/doc/docperl.css\">\n";
    print "</head><body>\n";
    ...
    print "<p><b>Location: </b>".$1."</p>\n";
    print "<p><b>Link to this Page: </b>http://www.joss.ucar.edu/cgi-bin/dpg/doc/docperl.cgi?file=".$file."</p>\n";
	...
	if (defined($functions{$function})) {
		...
		if ($item ne "") { 
                    # needed because split gives "" as first element
