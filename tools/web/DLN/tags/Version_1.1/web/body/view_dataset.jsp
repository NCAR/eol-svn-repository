	...
	<tr><td width=100% bgcolor=#dcdcdc>
		...
		<tr bgcolor=#dcdcdc class=navBar>
			<td align=left width=33%>
				...
				&nbsp;&nbsp;
				<font size=-1>
					<a target=_blank href=/cgi-bin/qcodiac/supervisor?results=ds_description&results=file_list&results=tape_list&dataset_id=<%= dataset.getStormId() %>>QCODIAC</a>	
				</font>
			</td>
	...
	<tr><td width=100%>
		<table width=100% border = 0 cellpadding=4 cellspacing=1> 
			...
			<tr bgcolor=white>
				...
				<td width=100%>
					<a target=_blank href=http://data.eol.ucar.edu/codiac/dss/id=<%= dataset.getStormId() %>><%= dataset.getStormId() %></a>
					&nbsp;&nbsp;&nbsp;&nbsp;
					<i>Back Door</i>: <a target=_blank href=http://data.eol.ucar.edu/codiac/dss/unhide/id=<%= dataset.getStormId() %>><%= dataset.getStormId() %></a>
				</td>
			</tr>
			<tr bgcolor=white>
