...
<html>
<head>
	<title>DLN: Dataset by project</title>
...
<table border=0 cellpadding=5 cellspacing=5>
				...
				out.println( 
					"<tr><td>&nbsp;</td>" +
						"<td id=folder_item><font size=-1>" +
							"<li><a href=../body/project_init.jsp?project=" + project.getPname() +
					 					" target=main>" + project.getPname() + "</a></b>" +
						"</td>" +
					"</tr>" );
			}	
		%>
	...
	<tr><td>
		<table border=0 cellpadding=0 cellspacing=0>
			<tr>
				...
				<td id=folder_item><b><a href=loaders.jsp>Loaders</a>
			</tr>
		</table>
	</td></tr>
	...
	<tr><td id=folder_item align=center>
		<b><a href="../body/welcome.html" target=main>DLN Home</a></b>
	</td></tr>
</table>
