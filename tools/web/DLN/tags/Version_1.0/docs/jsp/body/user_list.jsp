<%------------------------------------------------------------------------
 user_list.jsp: displays all of the users in the DLN for editting
------------------------------------------------------------------------%>
		...
		while( usrs.hasMoreElements() )
		{
			...
			%>
				<tr class=<%= trclass %> onmouseover="cursorOver(this);" onmouseout="cursorOut(this);">
					<td><a target=_top href=/dpgapps/dln/?loader=<%= user.getUid() %>><%= user.getUid() %></a></td>
