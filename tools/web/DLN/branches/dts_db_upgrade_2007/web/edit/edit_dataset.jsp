...
<form action="${pageContext.request.contextPath}/edit/util/proc_dataset.jsp" method="POST">
    ...
    <div class="sides">
        <div class="formSide">
		    <table class="datasetForm">
		        <tr>
		            <th>Dataset ID:</th>
		            <td><input type="text" name="datasetId" size=16 maxlength=15 value="${dataset.datasetId}" ></td>
		        </tr>
		        <tr>
		            <th>Name:</th>
		    ...
		    <table class="datasetForm">
		        ...
		        <tr>
		            <th>Remote URL:</th>
		            <td colspan="3"><input type=text size=60 maxlength=255 name="remoteURL" value="${dataset.remoteURL}"></td>
		        </tr>
		    </table>
		    <div class="shortSpacer"></div>
		    <table class="datasetForm">
		        <tr>
		            <th>Ingest Directory:</th>
		                ...
		                <select name="ingestType">
		                    ...
		                    for (IngestTypeBean type : sortedIngestTypes) {
		                        out.print("<option value=" + type.getTypeId() + 
		                                (dataset.getIngestType(ingestTypes) != null && dataset.getIngestType(ingestTypes).getTypeId() == (type.getTypeId()) ? " checked" : "")
		                                + ">" + type.getName() + "</option>");
		                    }
		                    %>
		                </select>
