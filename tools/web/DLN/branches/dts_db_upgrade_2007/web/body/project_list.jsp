...
<body>
    <jsp:include page="/body/fragment/project_titlebar.jsp">
        <jsp:param name="projectCount" value="<%= projects.getAllProjects().size() %>" />
    </jsp:include>
    <jsp:include page="/body/fragment/new_project_bar.jsp" />
	    ...
	    <table class="projectListing">
	        ...
	        <c:forEach var="project" items="<%= projectList %>">
	            ...
	            <tr class="${trclass}" onmouseover="javascript: rowHover(this, 'hoverRow');" onmouseout="javascript: rowHover(this, '${trclass}');">
	                <td><a href="${pageContext.request.contextPath}/body/dataset_list.jsp?project=${project.projectId}">${project.projectId}</a></td>
	                ...
	                <td>
	                    <a href="javascript: editProject('${pageContext.request.contextPath}/edit/edit_project.jsp?mode=edit&project=${project.projectId}');">
