...
<%
	...
	if( action.equals( "Update Project" ) ) {
		boolean good = ProjectDBA.updateDB( project, sourcePname );
		if( good )
		{
			onLoad = "top.opener.parent.main.location=\'/dpgapps/dln/body/project_list.jsp?hlight=" + project.getId() + "\'; showStatus( top.opener.parent.top_frame, \'Project+Has+Been+Updated\' ); close();";
