...
<%
	...
	if( action.equals( "Add Project" ) )
	{
		...
		if( good )
		{
			onLoad = "top.opener.parent.main.location=\'/dpgapps/dln/body/project_list.jsp?hlight=" + project.getPname() + "\'; showStatus( top.opener.parent.top_frame, \'Project+Has+Been+Added\' ); close();";
			msg = "Project Has Been Added";
		}
		else
		{
			msg = "There was an Error Adding the Project.  Contact <a href=mailto:suldan@joss.ucar.edu>Dan Sullivan</a>";	
		}
	}
	else if( action.equals( "Update Project" ) )
	{
		...
		if( good )
		{
			onLoad = "top.opener.parent.main.location=\'/dpgapps/dln/body/project_list.jsp?hlight=" + project.getPname() + "\'; showStatus( top.opener.parent.top_frame, \'Project+Has+Been+Updated\' ); close();";
			msg = "Project Has Been Updated";
		}
		else
		{
			msg = "There was an Error Updating the Project.  Contact <a href=mailto:suldan@joss.ucar.edu>Dan Sullivan</a>";	
		}
	}
	else
	{
