...
<%
	...
	if( action.equals( "Add User" ) )
	{
		...
		if( good )
		{
			onLoad = "top.opener.parent.main.location=\'/dpgapps/dln/body/user_list.jsp?hlight=" + user.getUid() + "\'; showStatus( top.opener.parent.top_frame, \'User+Has+Been+Added\' ); close();";
			msg = "User Has Been Added";
		}
		else
		{
			msg = "There was an Error Adding the User.  Contact <a href=mailto:suldan@joss.ucar.edu>Dan Sullivan</a>";	
		}
	}
	else if( action.equals( "Update User" ) )
	{
		...
		if( good )
		{
			onLoad = "top.opener.parent.main.location=\'/dpgapps/dln/body/user_list.jsp?hlight=" + user.getUid() + "\'; showStatus( top.opener.parent.top_frame, \'User+Has+Been+Updated\' ); close();";
			msg = "User Has Been Updated";
		}
		else
		{
			msg = "There was an Error Updating the User.  Contact <a href=mailto:suldan@joss.ucar.edu>Dan Sullivan</a>";	
		}
	}
	else
	{
