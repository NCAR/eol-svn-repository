<%------------------------------------------------------------------------
 project_list.jsp: displays all of the projects in the DLN for editting
------------------------------------------------------------------------%>
		...
		while( pjs.hasMoreElements() )
		{
			...
			%>
				<tr class=<%= trclass %> onmouseover="cursorOver(this);" onmouseout="cursorOut(this);">
					<td><a target=_top href=/dpgapps/dln/?project=<%= pj.getPname() %>><%= pj.getPname() %></a></td>
