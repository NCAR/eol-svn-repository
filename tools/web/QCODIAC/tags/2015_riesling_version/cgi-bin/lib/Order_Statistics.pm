...
sub queryForm {
	...
	<form action="supervisor" method="POST" onsubmit="return checkMetricForm()" style="margin:auto;padding:auto;">
		...
		<fieldset>
			...
			<button id="startdate_show"><img src=\"http://dmg.eol.ucar.edu/software/tools/web/qcodiac-test/calendar.png\"></button>
			<button id="clear_startdate">Clear</button>
			<br>
			<label for="end_date">End Date: </label>
			<input type="text" id="end_date" name="end_date" />
			<button id="enddate_show"><img src=\"http://dmg.eol.ucar.edu/software/tools/web/qcodiac-test/calendar.png\"></button>
