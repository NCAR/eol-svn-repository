...
sub queryResult {	
    ...
    my $sql = "SELECT category.*,parent.name as parent FROM category LEFT JOIN category as parent ON category.parent_category_id_fk=parent.category_id ORDER BY \'$sort\'";
