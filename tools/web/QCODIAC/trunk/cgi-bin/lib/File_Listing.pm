...
#  - Eric Dattore
#
#   Add hidden field, fix marking of hidden field, and fix comments - 10/2020
#   J. Scannell
#
...
#-----------------------------------------------------------------------------#
# new()
#   * Creates an instance of the File_Listing Tool
#
# shortDesc()
...
my @def_fields = ( "begin_date", "end_date", "purpose", "format", "hide", "exists" );
...
sub longDesc {
    return cr("<table border=0 cellpadding=0 cellspacing=0><tr><td>",
        ...
        "<dd><li>File name and path</li></dd>",
        "<dd><li>Begin/End Date</li></dd>",
        "<dd><li>File Existence</li></dd>",
...
sub queryForm {
    ...
    my $form = cr("<form action=supervisor method=POST onSubmit=\"return checkText( this.dataset_id, \'Please Enter a Dataset Id.\')\">" ,
        ...
        "<input type=checkbox checked name=fields value=event>Event" . &nbsp(3),
        "<input type=checkbox checked name=fields value=format>Data Format" . &nbsp(3),
        "<input type=checkbox name=fields value=size_kb>Data Size" . &nbsp(3),
