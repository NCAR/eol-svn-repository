...
#
# Rev. 11/11/2015
# Fix whitespace, add header.
# - Eric Dattore
#
#   Fix comments - 10/2020
#   J. Scannell
#
# This package obtains all of the available parameters listed in the URL, and
# makes lists of their values available as output through an instantiated obj.
#
#-----------------------------------------------------------------------------#
#                                Subroutines                                  #
#-----------------------------------------------------------------------------#
# new()
#   * Creates an instance of the URLparams Tool and loads the params into
#       a hash
#
# get()
