...
$jscript = "<script language=javascript src=\"http://www.joss.ucar.edu/master_list/ml2.js\"></script>";
...
sub left_css
{
	...
	return "<link rel=\"STYLESHEET\" type=\"text/css\" href=\"http://www.joss.ucar.edu/master_list/css/$src\">";
}
sub body_css
{
	my $src = shift;
...
$image_src = "http://www.joss.ucar.edu/master_list/images";
1;
