...
public class ProjectEditState extends ProjectState {
     ...
     **/
    public ProjectEditState(MasterListManager manager, MasterListState lastState)
    ...
    public ProjectEditState(MasterListManager manager, MasterListState lastState,
        ...
        // Set up the classification selector for the project.
        selector = new Selector(ClassificationBean.getClassifications(),
				ClassificationBean.getClassificationTypeList());
        selector.setIncluded(ClassificationProjectBean.getClassificationList(project));
    }
    ...
    public MasterListState accept(ActionEvent evt) throws MasterListException {
        ...
        for (Selectable item: selector.getIncludedItems()) {
            list.add((ClassificationBean)item);
        }
        project.setClassifications(list);
        ...
        return new DatasetListState(manager,getProject(),lastState.getClassificationType(),lastState.getClassification(),null);
    }
    ...
    /**
     * Get the Selector used for choosing the associated classifications for the
     * project.
     * @return The classification selector for the project.
     **/
