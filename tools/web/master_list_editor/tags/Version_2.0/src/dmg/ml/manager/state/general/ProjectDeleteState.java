...
public class ProjectDeleteState extends ProjectState {
     ...
     **/
    public ProjectDeleteState(GeneralManager manager, MasterListState lastState,
            ProjectBean project) {
        super(manager);
    ...
    /**
     * Get the selector used by the state for selecting categories.
    ...
    /**
     * Change the state to a state that lists categories.
     * @param evt The event that triggered the change of state.
