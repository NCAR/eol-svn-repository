...
<f:subview id="ProjectDeleteView">
    ...
    <h:form id="ProjectDeleteForm" style="background-color: red">
        <h:inputHidden value="#{generalManager.project.originalId}" />
        ...
        <h:panelGrid columns="1" styleClass="dataForm">
            ...
            <h:panelGrid columnClasses="formTitle" columns="1" styleClass="centered">
                <h:outputText value="#{generalManager.project.projectId}:" />
            </h:panelGrid>
            
            <h:outputText escape="false"
                    value="<p style=\"text-align: center;\"><b>Selecting <font color=\"red\"><i>Confirm</i></font> will <font color=\"red\">PERMANENTLY delete</font> all metadata for #{generalManager.project.projectId}.</b><br>Data sets <b>ONLY</b> associated with <b>#{generalManager.project.projectId}</b> will be <b>COMPLETELY</b> deleted.<br>Data sets associated with other projects are retained." />
            ...
            <h:panelGrid columnClasses="formTitle" columns="2" styleClass="centered">
                <h:outputText escape="false" styleClass="warning" value="<font size=+2>Are you sure you want to delete #{generalManager.project.projectId}?</font>" />
            </h:panelGrid>            
