...
<f:subview id="CategoryDeleteView">
    ...
    <h:form id="CategoryDeleteForm">
        <h:inputHidden value="#{manager.classification.classificationId}" />

        <h:panelGrid columns="1" styleClass="dataForm">
            <h:panelGrid columns="1" styleClass="centered">
                <h:outputText styleClass="formHeader" value="Classification Delete Confirmation" />
            </h:panelGrid>

            <h:panelGrid columnClasses="formTitle" columns="1" styleClass="centered">
                <h:outputText value="#{manager.classification.name}:" />
            </h:panelGrid>
            
            <h:outputText escape="false"
                    value="<p style=\"text-align: center;\"><b>Selecting <font color=\"red\"><i>Confirm</i></font> will <font color=\"red\">PERMANENTLY delete</font> all metadata for classification: #{manager.classification.name}.</b></p>" />
