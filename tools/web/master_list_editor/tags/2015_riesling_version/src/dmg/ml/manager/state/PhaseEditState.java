...
public class PhaseEditState extends PhaseState {
     ...
     * @return The state that displays the list of data sets for the phase
    ...
    public MasterListState accept(ActionEvent evt) throws MasterListException {
        if (phase.getPhaseId() == null || phase.getPhaseId() <= 0) {
            phase.insert();
        } else {
            phase.update();
        }
    ...
    /**
     * Change to the state that will delete this phase from the database.
     * @param evt The event that triggered the change of state.
     * @return The state that deletes the current phase from the database.
    ...
    /**
     * Change to the state that will edit this phase in the database.
     * @param evt The event that triggered the change of state.
    ...
    /**
     * Get the currently selected classification defined in the state.
    ...
    /**
     * Get the phase that is currently being editted.
     * @return The phase being editted.
     **/
