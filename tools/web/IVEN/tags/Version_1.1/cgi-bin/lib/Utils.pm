...
$css = "<link rel=\"STYLESHEET\" type=\"text/css\" href=\"/software/tools/web/iven/iven.css\">";

$jscript = "<script language=javascript src=\"/software/tools/web/iven/iven.js\"></script>";
...
$img_src = "/software/tools/web/iven/images";
