...
<table width="95%" border="1" cellspacing="1" cellpadding="2" height="860" bordercolor="#CCCCCC" name="main panel">
		...
		<tbody>
          		<g:each var="ds" in="${datasets}">
                    <tr class="listRow" onmouseover="cursorOver(this)" onmouseout="cursorOut(this)" >
                       ...
                       <td><g:link controller="dataset" action="edit" id="${ds.id}">${ds.title}</g:link>
                       </td>
                    </tr>
               </g:each>
		</tbody>
  ...
  <tr>
    <td height="221">
      <div align="center"><img src="${createLinkTo(dir:'images',file:'box_1.gif')}" width="700" height="260" alt="boxes"></div>
    </td>
  </tr>
  <tr>
    <td height="291">
