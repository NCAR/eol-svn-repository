...
<c:choose>
   ...
   <c:when test="${param.project == 'BEST'}">
      <c:import url="http://data.eol.ucar.edu/master_list/static/best/index.html" />
   </c:when>
   ...
   <c:when test="${param.project == 'CuPIDO'}">
      <c:import url="http://data.eol.ucar.edu/master_list/static/cupido/index.html" />
   </c:when>
   ...
   <c:when test="${param.project == 'MILAGRO'}">
      <c:import url="http://data.eol.ucar.edu/master_list/static/milagro/index.html" />
   </c:when>
   ...
   <c:when test="${param.project == 'PACDEX'}">
      <c:import url="http://data.eol.ucar.edu/master_list/static/pacdex/index.html" />
   </c:when>
   ...
   <c:when test="${param.project == 'WAMME'}">
      <c:import url="http://data.eol.ucar.edu/master_list/static/wamme/index.html" />
   </c:when>
   <c:otherwise>
<html>
<head>
