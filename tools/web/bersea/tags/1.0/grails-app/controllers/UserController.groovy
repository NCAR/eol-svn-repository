 ...
 * Actions over Researcher objects.
...
class UserController {
  ...
  def list = {
    ...
    [ personList: Researcher.list( params ) ]
  }

  def show = {
    [ person : Researcher.get( params.id ) ]
  }
  ...
  def delete = {
    ...
    def person = Researcher.get( params.id )
    ...
    if(person) {
      ...
      if(!(authPrincipal instanceof String) && authPrincipal.username!=person.username){
        ...
        person.delete()
        flash.message = "Researcher ${params.id} deleted."
      ...
      flash.message = "Researcher not found with id ${params.id}"
      redirect(action:list)
    }
  }
