...
<html>
  ...
  <body>
    <div class="nav">
      ...
      <span class="menuButton"><g:link action="list">Researcher List</g:link></span>
    </div>
    <div class="body">
          ...
          <table>
            <tbody>
              ...
              <tr class='prop'>
                ...
                <td valign='top'
                    class='value ${hasErrors(bean:person,field:'organization','errors')}'>
                  <input type="text" name='organization'
                         value="${person?.organization?.encodeAsHTML()}"/>
                </td>
              </tr>  
             ...
             <tr class='prop'>
                ...
                <td valign='top'
                    class='value ${hasErrors(bean:person,field:'phoneNumber','errors')}'>
                  <input type="text" name='phoneNumber'
                         value="${person?.phoneNumber?.encodeAsHTML()}"/>
                </td>
              </tr>
