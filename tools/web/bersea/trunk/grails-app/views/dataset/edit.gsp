                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:dataset,field:'project','errors')}">
                                    <g:select optionKey="id" from="${myList}" name="project.id" value="${dataset?.project?.id}" ></g:select>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:dataset,field:'discipline','errors')}">
                                    <g:select optionKey="id" from="${Discipline.list()}" name="discipline.id" value="${dataset?.discipline?.id}" ></g:select>
                                </td>
                            </tr> 
