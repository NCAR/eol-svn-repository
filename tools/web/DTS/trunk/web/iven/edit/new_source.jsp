...
<jsp:useBean id="product" scope="request" class="dln.beans.DatasetBean" />
...
<head>
	...
	<title>Source Data Set Loader</title>
...
<form action="${pageContext.request.contextPath}/iven/edit/util/proc_new_source.jsp" method="POST">
...
<div class="form">
	<table>
		<tr><td class="uneditableName">${product.datasetId}: ${product.name}</td></tr>
	</table>
</div>
<div class="spacer"></div>
...
<div class="form">
	<table>
		<tr>
			<th class="required">Source Dataset ID:</th>
