...
<div class="dropdownBar">
    ...
    <div class="button">
        <button onclick="javascript: editDataset( '${pageContext.request.contextPath}/dln/edit/edit_dataset.jsp?mode=add' );">Add New</button>
    </div>
    <c:if test="${display.displayProjectList}">
	    <div class="button">
	    	<button onClick="javascript: parent.location.href='${pageContext.request.contextPath}/iven/dataset_list.jsp?projectId=${display.displayId}';">IVEN Dataset List</button>
	    </div>
	</c:if>
