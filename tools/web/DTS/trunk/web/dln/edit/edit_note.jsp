...
<form action="${pageContext.request.contextPath}/dln/edit/util/proc_note.jsp" method="POST">
    ...
    <div class="buttons">
        <c:choose>
            <c:when test="${param.mode == null || param.mode == 'add'}">
                <input type=submit name=action value="Add Note" onClick="if (validateNoteForm(this.form)) { return checkSendMail(this.form); } else { return false; }">
                <input type=submit name=action value="Cancel">
            </c:when>
            <c:otherwise>
                <input type=submit name=action value="Update Note" onClick="if( validateNoteForm(this.form) ) { return checkSendMail( this.form ); } else { return false; }">
                <input type=submit name=action value="Cancel">
            </c:otherwise>
        </c:choose>
    </div>
