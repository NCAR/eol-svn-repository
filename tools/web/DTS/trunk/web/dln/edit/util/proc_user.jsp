...
<c:choose>
    <c:when test="${param.action == 'Add User'}">
        ...
        try {
        	user.insert();
            onLoad = "top.opener.parent.left.location.reload(true); top.opener.parent.main.location=\'/dts/dln/body/user_list.jsp?hlight=" + user.getContactId() + "\'; showStatus( top.opener.parent.top_frame, \'User+Has+Been+Added\' ); close();";
    ...
    <c:when test="${param.action == 'Update User'}">
        <%
        try {
        	user.update(request.isUserInRole("super"));
            onLoad = "top.opener.parent.left.location.reload(true); top.opener.parent.main.location=\'/dts/dln/body/user_list.jsp?hlight=" + user.getContactId() + "\'; showStatus( top.opener.parent.top_frame, \'User+Has+Been+Updated\' ); close();";
...
<jsp:forward page="/dln/edit/edit_user.jsp">
