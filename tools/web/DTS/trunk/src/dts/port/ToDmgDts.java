...
public class ToDmgDts {
	...
	private static final String DLN_URL  = "jdbc:mysql://farskkol.eol.ucar.edu/dmg_dln";
	private static final String ML_URL   = "jdbc:mysql://farskol.eol.ucar.edu/dmg_merged_ml";
	private static final String IVEN_URL = "jdbc:mysql://farskol.eol.ucar.edu/dmg_iven";
	private static final String ZITH_URL = "jdbc:mysql://farskol.eol.ucar.edu/zith9";
	// private static final String ZITH_URL = "jdbc:mysql://sferic-dev.eol.ucar.edu/zith9";
	 ...
	 * @throws SQLException if there is a problem accessing or reading the ZITH database.
	 */
	public void loadEMDAC() throws SQLException {
		// Get the connection to the ZITH database.
		...
		// Close the ZITH connection since it is no longer needed.
		try { connection.close(); } catch (SQLException e) {}
