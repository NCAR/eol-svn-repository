...
<%
	...
	if (action.equals( "Load" )) {
		try {
			...
			} else if (dataset.isProcessedDataset()) {
				msg = "<p>Dataset "+dataset.getDatasetId()+" is already a processed dataset.</p>";
			}
		} catch (SQLException e) {
			msg = "<p>There has been an error trying to load the dataset.  The dataset may not exist in the DLN.</p>";
...
<jsp:forward page="/iven/edit/new_proc_dataset.jsp">
