...
<form action="${pageContext.request.contextPath}/dln/edit/util/proc_project.jsp" method="POST">
    ...
    <div class="buttons">
	    <c:choose>
	        <c:when test="${param.mode == 'add'}">
	            <input type=submit onClick="javascript: return validateProject(this.form);" name=action value="Add Project">
	            <input type=submit name=action value="Cancel">
	        </c:when>
	        <c:otherwise>
	            <input type=submit onClick="javascript: return validateProject(this.form);" name=action value="Update Project">
	            <input type=submit name=action value="Cancel">
	        </c:otherwise>
	    </c:choose>
    </div>
