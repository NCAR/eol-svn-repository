...
<%
	...
	// Load a data set from the database.
	else if (action.equals("Load")) { %>
		<jsp:forward page="/dln/edit/edit_dataset.jsp">
			<jsp:param name="mode" value="load" />
			<jsp:param name="datasetId" value="${dataset.datasetId}" />
		</jsp:forward>
	<% }
