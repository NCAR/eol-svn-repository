...
<c:choose>
    <c:when test="${param.action == 'Add Project'}">
        ...
        try {
        	project.insert();
            onLoad = "top.opener.parent.left.location.reload(true); top.opener.parent.main.location=\'/dts/dln/body/project_list.jsp?hlight=" + project.getProjectId() + "\'; showStatus( top.opener.parent.top_frame, \'Project+Has+Been+Added\' ); close();";
    ...
    <c:when test="${param.action == 'Update Project'}">
        ...
        try {
        	project.update();
            onLoad = "top.opener.parent.left.location.reload(true); top.opener.parent.main.location=\'/dts/dln/body/project_list.jsp?hlight=" + project.getProjectId() + "\'; showStatus( top.opener.parent.top_frame, \'Project+Has+Been+Updated\' ); close();";
...
<jsp:forward page="/dln/edit/edit_project.jsp">
