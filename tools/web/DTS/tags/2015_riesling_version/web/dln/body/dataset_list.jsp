...
<body>
    <jsp:include page="/dln/body/fragment/dataset_titlebar.jsp">
        <jsp:param name="title" value="<%= title %>" />
        <jsp:param name="datasetCount" value="<%= datasetList.size() %>" />
    </jsp:include>
    <jsp:include page="/dln/body/fragment/drop_downs.jsp" />
    ...
    <div class="listing">
        <table class="datasetListing">
            ...
            for (DatasetBean dataset: datasetList) {
                ...
                out.print("<td class=\"icon\">");
                out.print("<a href=\"javascript: editDataset('");%>${pageContext.request.contextPath}/dln/edit/edit_dataset.jsp?mode=update&datasetId=<%
                out.print(dataset.getDatasetId());
                out.print("');\">");
