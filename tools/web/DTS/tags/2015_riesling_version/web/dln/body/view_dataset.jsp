...
<body>
    ...
    <div class="dropdownBar">
        <div class="dropdown">
            <span class="small">
                <button onClick="javascript: location='${pageContext.request.contextPath}/dln/body/dataset_list.jsp';">
                    RETURN TO 
                    <%
                	if (display.isDisplayProjectList()) {
                		out.print("PROJECT");
        ...
        <div class="button">
            <span class="small">
                <button onClick="javascript: editDataset( '${pageContext.request.contextPath}/dln/edit/edit_dataset.jsp?mode=update&datasetId=<%= dataset.getDatasetId() %>' )">EDIT</button>
                 &nbsp; 
    ...
    <div class="listing">
		...
		<td>
		    <%
			if (dataset.getReadmeURL() != null && !dataset.getReadmeURL().equals("")) {
			    out.print("<a target=\"_blank\" href=\"");
			    out.print(dataset.getReadmeURL());
			    out.print("\">");
			    out.print(dataset.getReadmeURL());
			    out.print("</a>");
			}
    ...
    <div class="noteHeaderBar">
        ...
        Notes
        <button onClick="javascript: editNote( '${pageContext.request.contextPath}/dln/edit/edit_note.jsp?datasetId=<%= dataset.getDatasetId() %>' )">New Note</button></div>
    <div class="spacer"></div>
        ...
        <%
        	...
        	for (NoteBean note : dataset.getReverseNoteList(display.getNoteTypeFilterSelection(), display.getAuthorFilterSelection())) {
        		...
        		if (note.getAuthor(users) != null) {%>
        		    &nbsp;&nbsp;<a href="javascript: editNote('${pageContext.request.contextPath}/dln/edit/edit_note.jsp?mode=update&datasetId=<%= dataset.getDatasetId() %>&noteId=<%= note.getNoteId() %>')"><img src="${pageContext.request.contextPath}/images/edit.gif" /></a>&nbsp;&nbsp;
        		<%}
        		out.print(" (");
        		if (note.getAuthor(users) == null) {
