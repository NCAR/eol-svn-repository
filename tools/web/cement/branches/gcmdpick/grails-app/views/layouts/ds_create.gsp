		                        ...
		                        <div id="links"> 
		                          <div id="button"> 
                                    ...
                                    <ul>
        							  ...
        							  <li><a><span style="border-width: 3px; padding: 3px 0.2em; color: gray; font-size: 8.5pt; font-weight: bold; text-align: center;">My Profile</span></a></li>
                                      </font>
                                    </ul>
                                    <br>
                                    <ul>
									<font face="Arial, Helvetica, sans-serif">
        							  ...
        							  <li><a><span style="border-width: 3px; padding: 3px 0.2em; color: gray; font-size: 8.5pt; font-weight: bold; text-align: center;">New submission</span></a></li>
        							  <li><a><span style="border-width: 3px; padding: 3px 0.2em; color: gray; font-size: 8.5pt; font-weight: bold; text-align: center;">Previously submitted</span></a></li>
                                      </font>
                                    </ul>
                                    <br>
								    <ul>
                                    ...
                                    <br>
        							  ...
        							  <li><a><span style="border-width: 3px; padding: 3px 0.2em; color: gray; font-size: 8.5pt; font-weight: bold; text-align: center;">CADIS home</span></a></li>
                                      </font>
								    </ul>
                             </td>
