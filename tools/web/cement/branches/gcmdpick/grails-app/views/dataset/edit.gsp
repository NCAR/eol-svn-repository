                    ...
                    <table>
                        <tbody>
                           ...
                           <tr class='req'>
                            ...
                            <tr class='prop'>
                                <td valign='top' class='name'>
                                   <label for='summary'>3. Data Set Summary:</label>
                                </td>
                            ...
                            <tr class='req'>
                                ...
                                <td valign='top' class='value ${hasErrors(bean:dataset,field:'metadataContact','errors')}'>
                                    <g:select optionKey="id" from="${contacts}" name='metadataContact.id' value="${dataset?.metadataContact?.id}" noSelection="['null':'-choose a contact-']" ></g:select> <span class="menuButton"><g:link controller="contact" action="create">add new contact</g:link></span>
                                </td>
                            </tr> 
                            ...
                            <tr class='req'>
                                ...
                                <td valign='top' class='value ${hasErrors(bean:dataset,field:'datacenterContact','errors')}'>
                                    <g:select optionKey="id" from="${contacts}" name='datacenterContact.id' value="${dataset?.datacenterContact?.id}" noSelection="['null':'-choose a contact-']" ></g:select> <span class="menuButton"><g:link controller="contact" action="create">add new contact</g:link></span>
                                </td>
                            </tr> 
