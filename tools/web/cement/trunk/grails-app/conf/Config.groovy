// main grails config file

// it appears that we can use the injected variables
//   ${userHome} ${grailsHome} ${appName} ${appVersion}
// and also System.properties[] (aka System.getProperty())
...
// where grails will put temp files, default ${userHome}/.grails/...
//grails.work.dir =
...
log4j {
    ...
    logger {
        ...
        org {
            ...
            codehaus.groovy.grails.commons="error,stdout" // core / classloading
