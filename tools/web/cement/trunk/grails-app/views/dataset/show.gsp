        ...
        <div class="body">
                ...
                <table>
                    <tbody>
                       ...
                       <tr class="prop">
                            ...
                            <td valign="top" class="value">${dataset.title.encodeAsHTML()}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${dataset.minimumLatitude?.encodeAsHTML()}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${dataset.maximumLatitude?.encodeAsHTML()}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${dataset.minimumLongitude?.encodeAsHTML()}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${dataset.maximumLongitude?.encodeAsHTML()}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${dataset?.topic?.encodeAsHTML()}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${dataset?.metadataContact?.encodeAsHTML()}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name" nowrap>Datacenter Contact:</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${dataset.dataAccess?.encodeAsHTML()}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">Ext. Reference:</td>
                            
                            <td valign="top" class="value">${dataset.xlink1?.encodeAsCdpURL()}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${dataset?.xlink1Purpose}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${dataset.xlink2?.encodeAsCdpURL()}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${dataset?.xlink2Purpose}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${dataset.dataTags?.encodeAsHTML()}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${dataset.datasetLanguage?.encodeAsHTML()}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${dataset.accessRestrictions?.encodeAsHTML()}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${dataset.useConstraints?.encodeAsHTML()}</td>
                            
                        </tr>
                     
                         <tr class="prop">
                            <td valign="top" class="name">CDP Entry ID:</td>
                            <td valign="top" class="value">${dataset.entryID?.encodeAsHTML()}</td>
                        </tr>
            ...
            <div class="buttons">
                <g:form controller="dataset">
		    		...
		    		<span class="menuButton"><g:link action="submit" id="${dataset.id}">Submit metadata</g:link></span>
