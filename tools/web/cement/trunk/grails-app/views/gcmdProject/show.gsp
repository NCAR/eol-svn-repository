                   ...
                   <tbody>
                        ...
                        <tr class="prop">
                              <td valign="top" class="name">Id:</td>
                                    ...
                                    <td valign="top" class="value">${gcmdProject.id}</td>
                        ...
                        <tr class="prop">
                              <td valign="top" class="name">Keyword:</td>
                                    ...
                                    <td valign="top" class="value">${gcmdProject.keyword}</td>
