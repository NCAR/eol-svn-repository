...
<body>
        <div class="body">
  			<div class="altsubsubtitle" align="left">Review Contact</div>
			<br>
           ...
           <div class="dialog">
                 <table>
                   <tbody>
                        ...
                        <tr class="prop">
                              <td valign="top" class="name">State or Province:</td>
                        ...
                        <tr class="prop">
                              <td valign="top" class="name">PI Projects:</td>
           ...
           <div class="buttons">
               <g:form controller="contact">
                 ...
                 <span class="button"><g:actionSubmit value="Delete" onclick="return confirm('Are you sure?');" /></span>
               </g:form>
           </div>
        </div>
      </table>
