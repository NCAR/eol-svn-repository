		                        ...
		                        <div id="links"> 
		                          <div id="button"> 
                                    ...
                                    <ul>
        							  ...
        							  <li><a><span style="border-width: 3px; padding: 3px 0.2em; color: gray; font-size: 8.5pt; font-weight: bold; text-align: center;">Cancel editing</span></a></li>
            						  <li><g:link controller="cdp" action="publish" id="${dataset.id}">Submit metadata</g:link></li>
                                    <br>
