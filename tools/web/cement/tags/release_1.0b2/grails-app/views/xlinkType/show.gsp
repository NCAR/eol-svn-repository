...
<html>
    ...
    <body>
        ...
        <div class="body">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${xlinkType.id}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${xlinkType.purpose}</td>
            ...
            <div class="buttons">
                <g:form>
                    <input type="hidden" name="id" value="${xlinkType?.id}" />
