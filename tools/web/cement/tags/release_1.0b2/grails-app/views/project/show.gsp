            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">CDP Name:</td>
                            <td valign="top" class="value">${project.cdpName}</td>
                        </tr>

                        <tr class="prop">
                            <td valign="top" class="name">CDP Entry ID:</td>
                            <td valign="top" class="value">${project.entryID}</td>
                        </tr>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${project.discipline}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${project?.piContact}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${project.dateCreated}</td>
                        </tr>
                   
                        <tr class="prop">
                            <td valign="top" class="name">Revision Date:</td>
                            <td valign="top" class="value">${project.lastUpdated}</td>
                        </tr>
