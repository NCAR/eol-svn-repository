                        ...
                        <tbody>
                             ...
                             <tr class='req'>
                                ...
                                <td valign='top' class='value ${hasErrors(bean:dataset,field:'project','errors')}'>
                                    <g:select tabindex="1" optionKey="id" from="${Project.list().sort()}" name='project.id' value="${dataset?.project?.id}"  noSelection="['null':'-choose the project-']"></g:select>
                                </td>
                            </tr> 
                           ...
                           <tr class='req'>
                            ...
                            <tr class='req'>
                                ...
                                <td valign='top' class='value ${hasErrors(bean:dataset,field:'topic','errors')}'>
                                    <g:select tabindex="16" optionKey="id" from="${IsoTopic.list()}" name='topic.id' value="${dataset?.topic?.id}"  noSelection="['null':'-choose an ISO topic-']" ></g:select>
                                </td>
                            </tr> 
