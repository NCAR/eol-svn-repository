...
<documentation type="IPY">${it.project?.title}</documentation>

<g:if test="${it.dataAccess}">
<documentation xlink:href="${it.dataAccess}" xlink:title="Data Access" type="extURL" />
</g:if>
<g:if test="${it.xlink1}">
<documentation xlink:href="${it.xlink1}" xlink:title="${it.xlink1Purpose}" type="extURL" />
</g:if>
<g:if test="${it.xlink2}">
<documentation xlink:href="${it.xlink2}" xlink:title="${it.xlink2Purpose}" type="extURL" />
</g:if>
...
<keyword>${it.dataTags.encodeAsCdp()}</keyword>
