...
<html>
    ...
    <body>
        <div class="body">
  			<div class="altsubsubtitle" align="left">Create Contact</div>
			<br>
               ...
               <div class="dialog">
                <table>
                    <tbody>
                                  ...
                                  <tr class='req'><td valign='top' class='name' nowrap><label for='organizationName'>Organization Name:</label></td><td valign='top' class='value ${hasErrors(bean:contact,field:'organizationName','errors')}'><input type="text" name='organizationName' value="${contact?.organizationName?.encodeAsHTML()}"/></td></tr>
