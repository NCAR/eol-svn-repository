      ...
      <div align="center">
        <table width="95%" border="0" cellspacing="1" cellpadding="2" height="185" name="Buttons" bordercolor="#CCCCCC">
          <tr>
			...
			<a href="dataset/create"><img src="${createLinkTo(dir:'images/buttons',file:'new_dataset.gif')}"width="150" height="50" border="0" alt="New_dataset" /></a>
			<a href="dataset/edit"><img src="${createLinkTo(dir:'images/buttons',file:'edit_dataset.gif')}" width="150" height="50" border="0" alt="Edit_dataset"></a></td>
          </tr>
        </table>
        <p>&nbsp;</p>
      </div>
