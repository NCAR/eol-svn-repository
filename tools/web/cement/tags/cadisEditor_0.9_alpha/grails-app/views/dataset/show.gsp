...
<html>
    ...
    <body>
        <div class="body">
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="contact" action="show" id="${dataset?.project?.piContact?.id}"> ${dataset?.project?.piContact?.personName?.encodeAsHTML()}</g:link></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">EntryID:</td>
		    ...
		    <span class="menuButton"><g:link controller="cdp" action="publish" id="${dataset.id}">Continue and Publish Metadata</g:link></span>
