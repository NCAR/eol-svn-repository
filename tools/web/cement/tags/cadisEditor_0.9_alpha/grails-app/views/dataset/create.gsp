...
<html>
    ...
    <body>
        <div class="body">
            <h1>Provide Metadata for New Dataset</h1>
            ...
            <g:form action="save" >
                        ...
                        <tbody>
                            ...
                            <tr class='prop'>
                                ...
                                <td valign='top' class='value ${hasErrors(bean:dataset,field:'metadataContact','errors')}'>
                                    <g:select optionKey="id" from="${Contact.list().sort()}" name='metadataContact.id' value="${dataset?.metadataContact?.id}" noSelection="['null':'-choose a contact-']"></g:select> <span class="menuButton"><g:link controller="contact" action="create">create new contact</g:link></span>
                                </td>
                            </tr> 
                            ...
                            <tr class='req'>
                                ...
                                <td valign='top' class='value ${hasErrors(bean:dataset,field:'datacenterContact','errors')}'>
                                    <g:select optionKey="id" from="${Contact.list().sort()}" name='datacenterContact.id' value="${dataset?.datacenterContact?.id}" noSelection="['null':'-choose a contact-']" ></g:select> <span class="menuButton"><g:link controller="contact" action="create">create new contact</g:link></span>
                                </td>
                            </tr> 
                            ...
                            <tr class='prop'>
                                ...
                                <td valign='top' class='value ${hasErrors(bean:dataset,field:'dateCreated','errors')}'>
                                    <g:datePicker name='dateCreated' value="${dataset?.dateCreated}" ></g:datePicker>
                                </td>
                            </tr> 
                ...
                <div class="buttons">
                    <span class="button"><g:actionSubmit value="Create" /></span><br>
                    <span class="button">&nbsp;<g:link action="review">Cancel</g:link>&nbsp;and return to review</span><br>
                </div>
            </g:form>
        </div>
