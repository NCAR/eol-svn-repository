                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class='prop'>
                                <td valign='top' class='name'>
                                    <label for='cdpName'>Cdp Name:</label>
                                </td>
                                <td valign='top' class='value ${hasErrors(bean:project,field:'cdpName','errors')}'>
                                    <input type="text" id='cdpName' name='cdpName' value="${fieldValue(bean:project,field:'cdpName')}"/>
                                </td>
                            </tr> 
                            ...
                            <tr class='prop'>
                                ...
                                <td valign='top' class='value ${hasErrors(bean:project,field:'entryID','errors')}'>
                                    <input type="text" id='entryID' name='entryID' maxlength='255' size='80' value="${fieldValue(bean:project,field:'entryID')}"/>
                                </td>
                            </tr> 
                            ...
                            <tr class='prop'>
                                ...
                                <td valign='top' class='value ${hasErrors(bean:project,field:'datasets','errors')}'>
								...
								<g:link controller='dataset' params='["project.id":project?.id]' action='create'>Add Dataset</g:link>
                                </td>
                            </tr> 
