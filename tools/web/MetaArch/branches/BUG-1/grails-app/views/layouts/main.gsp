<!doctype html>
	...
	<head>
        ...
        <script type="text/javascript">
			...
			function downloadFile() {} // Overloaded elsewhere
		</script>

		<g:layoutHead/>
        <r:layoutResources />
        
        <g:render template="/layouts/anytime_plugin"/>
...
<%--        </sec:ifLoggedIn>--%>
	...
	<body onload="printCurrentYear(); adjustNavWidth(); downloadFile();">
		<g:render template="/layouts/nav_org_wrap"/>
		<g:render template="/layouts/header"/>
		
		<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_DEVELOP">
		<g:render template="/layouts/admin_menu" />
		</sec:ifAnyGranted>
