...
<div class="fieldcontain ${hasErrors(bean: datasetInstance, field: 'files', 'error')} ">
	...
	<br />
	<span class="tooltip-ui">Don't see the file type you're looking for? &nbsp;&nbsp;<a href="mailto:metaarch@eol.ucar.edu?subject=[MetaArch] New File Type Suggestion">Suggest a new file type.</a></span>
