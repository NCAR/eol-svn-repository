...
<div class="title fieldcontain ${hasErrors(bean: projectInstance, field: 'name', 'error')} required">
	<label for="name">
		...
		<meta:tooltip domain="project" prop="name" />
	</label>
...
<div class="title fieldcontain ${hasErrors(bean: projectInstance, field: 'fullName', 'error')} required">
	<label for="fullName">
		...
		<span class="required-indicator">*</span>
		<meta:tooltip domain="project" prop="fullName" />
	</label>
...
<div class="fieldcontain ${hasErrors(bean: projectInstance, field: 'summary', 'error')} ">
	<label for="summary">
		...
		<meta:tooltip domain="project" prop="summary" />
	</label>
...
<div class="fieldcontain ${hasErrors(bean: projectInstance, field: 'fundingAgency', 'error')} required">
	<label for="fundingAgency">
		...
		<span class="required-indicator">*</span>
		<meta:tooltip domain="project" prop="fundingAgency" />
	</label>
...
<div class="dateRange fieldcontain ${hasErrors(bean: projectInstance, field: 'beginDate', 'error')} ">
	<label for="beginDate">
		...
		<meta:tooltip domain="project" prop="beginDate" />
	</label>
	<meta:dateTimeInputter name="beginDate" domain="prj" precision="minute" value="${projectInstance?.beginDate}"/>
...
<div class="dateRange fieldcontain ${hasErrors(bean: projectInstance, field: 'endDate', 'error')} ">
	<label for="endDate">
		...
		<meta:tooltip domain="project" prop="endDate" />
	</label>
	<meta:dateTimeInputter name="endDate" domain="prj" precision="minute" value="${projectInstance?.endDate}"/>
...
<div class="title fieldcontain ${hasErrors(bean: projectInstance, field: 'logo', 'error')} ">
	<label for="logo">
		<g:message code="project.logo.label" default="Project Logo (URL)" />
		<meta:tooltip domain="project" prop="logo" />
	</label>
	<g:textField name="logo" value="${projectInstance?.logo}"/>
</div>
<div style="clear: both;"></div>

<div class="title fieldcontain ${hasErrors(bean: projectInstance, field: 'docGuideUrl', 'error')} ">
	<label for="docGuideUrl">
		<g:message code="project.docGuideUrl.label" default="Project Documentation Guidelines (URL)" />
		<meta:tooltip domain="project" prop="docGuideUrl" />
	</label>
	<g:textField name="docGuideUrl" value="${projectInstance?.docGuideUrl}"/>
</div>
<div style="clear: both;"></div>
...
<div class="title fieldcontain ${hasErrors(bean: projectInstance, field: 'cssUrl', 'error')} ">
	<label for="cssUrl">
		...
		<meta:tooltip domain="project" prop="cssUrl" />
	</label>
...
<div class="fieldcontain ${hasErrors(bean: projectInstance, field: 'additionalMetadata', 'error')} ">
	<label for="additionalMetadata">
		...
		<meta:tooltip domain="project" prop="additionalMetadata" />
	</label>
