...
<html>
	...
	<body>
		<a href="#create-datasetCategory" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div class="nav" role="navigation">
			<g:render template="nav"/>
		</div>
		<div id="create-datasetCategory" class="content scaffold-create" role="main">
