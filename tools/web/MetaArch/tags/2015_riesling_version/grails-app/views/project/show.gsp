				...
				<sec:ifAnyGranted roles="ROLE_ADMIN,ROLE_DEVELOP">
					...
					<g:form>
						<fieldset>
							...
							<g:selectMemberType />
							<br />
							<g:textField name="username" onchange="" />
							<br />
<%--							<g:submitToRemote class="modifyGroup" action="modifyGroup" value="Add" />--%>
			...
			<ol class="property-list project">
				...
				<li class="fieldcontain">
					<span id="fullName-label" class="property-label"><g:message code="project.fullName.label" default="Full Name" /></span>
				...
				<li class="fieldcontain">
					<span id="fundingAgency-label" class="property-label"><g:message code="project.fundingAgency.label" default="Funding Agency" /></span>
