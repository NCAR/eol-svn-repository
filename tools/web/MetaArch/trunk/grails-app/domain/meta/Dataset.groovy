...
class Dataset {
	 ...
	 * 	- author - the creator/owner of the dataset; this field will be renamed to "owner" in the next development phase
    ...
    static constraints = {
		...
		accessRestrictions(inList:["No restrictions", "Password protected"], blank:false)
