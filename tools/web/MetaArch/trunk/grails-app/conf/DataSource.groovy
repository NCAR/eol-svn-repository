...
environments {
    development {
        dataSource {
          // on sferic_dev user landof must be on localhost: landof@localhost
          // same for my laptop  
          url = 'jdbc:mysql://localhost/metaarch_dev'
          //url = 'jdbc:mysql://192.168.33.10/metaarch_dev'
    ...
    production {
        dataSource {
			// Update database connection to farskol since riesling doesn't exist anymore
            //url = 'jdbc:mysql://localhost/metaarch_prod'
              url = 'jdbc:mysql://farskol.eol.ucar.edu/metaarch_prod'
