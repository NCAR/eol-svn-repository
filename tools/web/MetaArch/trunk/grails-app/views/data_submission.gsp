...
<%--					</li>--%>
		...
		<div class="main-body">	
				...
				-->
				  ...
				  <p>
					Once your data set has been created, you can add files to the data set by clicking on the "Upload Files" link at the bottom of the data set display page, as shown below:
				  </p>
