...
struct ncvar {			/* variable */
    char name[NC_MAX_NAME];
    nc_type type;            /* float, or int, or string, or..., etc */
    int ndims;               /* the number of dimensions of the variable */
    int dims[MAX_VAR_DIMS];  /* list of dimension IDs describing the shape of the variable */
    int natts;               /* number of attributes assigned to the variable */
    boolean has_fillval;
    double fillval;
};
